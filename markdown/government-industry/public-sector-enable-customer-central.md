...
3.  Select **Activate Customer Central** to install the plugin.
    ...
    You can perform other changes to this layout, as needed. For more information, see [Configure the Customer Information view using the CSM Configurable Workspace](../customer-service-management/cust-central-configure-info-tab.md).
