...
For general information about business rules, see [Classic Business rules](../../api-reference/business-rules-classic/c_BusinessRules.md).
...
The time that the business rule should execute. For more information about when business rules run, see [How business rules work](../../api-reference/business-rules-classic/c_BusinessRules.md).Valid values:
...
The record options that the business rule applies to. For more information about business rule actions, see [How business rules work](../../api-reference/business-rules-classic/c_BusinessRules.md).Valid values:
...
A filter query that specifies the fields and values that must be true for the business rule to run. For more information, see [Operators available for filters and queries](../../platform-user-interface/r_OpAvailableFiltersQueries.md).
