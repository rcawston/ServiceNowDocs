...
Preconfigured questions that you can't change.Admins create question sets in Service Catalog. For more information, see [Service catalog variable sets](../../servicenow-platform/service-catalog/c_ServiceCatalogVariableSets.md).
...
Conditions that must be met to view certain choices. Select **Add condition** and use the condition builder to create the filter. For more information, see [Condition builder](../../platform-user-interface/c_ConditionBuilder.md).
