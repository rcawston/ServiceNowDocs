...
Playbook authors can provide text directions to create multi-stage playbooks with [placeholder activities](../../build-workflows/workflow-studio/placeholder-activity.md) \(![placeholder activity icon.](../images/placeholder-activity-icon.png)\).
...
**Note:** Generating or regenerating a playbook preview counts as 10 assists. To track your Now Assist usage, see [Monitoring Now Assist usage in Subscription Management](../../platform-administration/monitoring-now-assist-usage.md).
