...
For an example showing how where the description generated by this script appears, see [Description generation script example](atf-step-config-xmpls.md#description-generation-script-example).
