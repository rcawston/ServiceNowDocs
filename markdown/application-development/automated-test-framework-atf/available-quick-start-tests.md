...
If the PPM Standard plugin \(com.snc.financial\_planning\_pmo\) is active, verify that a Demand can be converted to an Agile 2.0 story using the **Create Story** related link on the Demand form. For more information on how to create an Agile 2.0 story from a demand, see [Create an artifact from a demand](../../it-business-management/demand-management/t_CrtArtftDmdMnu.md).
...
If the PPM Standard plugin \(com.snc.financial\_planning\_pmo\) is active, verify that a Demand can be converted to an Agile 2.0 epic using the **Create Epic** related link on the Demand form.For more information on how to create an Agile 2.0 epic from a demand, see [Create an artifact from a demand](../../it-business-management/demand-management/t_CrtArtftDmdMnu.md).
...
</table>To learn more about Agile Development 2.0, see [Agile Development 2.0](../../it-business-management/agile-development/agile-landing-page.md).
...
To learn more about Enterprise Architecture \(formerly Application Portfolio Management\), see [Enterprise Architecture](../../application-portfolio-management/application-portfolio-management-landing-page.md) .
...
To learn more about Assessments and Surveys, see [Service administration](../../servicenow-platform/c_ServiceAdministration.md).
...
To learn more about Change Management, see [Change Management](../../it-service-management/change-management/c_ITILChangeManagement.md).
...
To learn more about Cloud Provisioning and Governance, see [Cloud Provisioning and Governance](../../it-operations-management/cloud-configuration-governance/cloud-management-v2-landing-page.md).
...
To learn more about coaching, see [Coaching](../../it-service-management/coaching/cf-coaching-landing.md).
...
To learn more about Communities, see [Communities](../../customer-service-management/communities/servicenow-communities.md).
...
To learn more about Configuration Compliance, see [Configuration Compliance](../../security-management/configuration-compliance/vr-config-compliance-landing.md).
...
To learn more about Configuration Management Database, see [Configuration Management Database](../../servicenow-platform/configuration-management-database-cmdb/c_ITILConfigurationManagement.md).
...
To learn more about Continual Improvement Management, see [Continual Improvement Management](../../it-service-management/continual-improvement-management/cim-landing-page.md).
...
To learn more about Customer Service Management, see [Customer Service Management](../../customer-service-management/c_CustomerServiceManagement.md).
...
To learn more about Dashboards, see [Dashboards](../../now-intelligence/performance-analytics/dashboards-landing-page.md).
...
To learn more about DevOps, see [DevOps Change Velocity](../../it-service-management/devops-change-velocity/devops-landing-page-new.md).
...
If the PPM Standard plugin \(com.snc.financial\_planning\_pmo\) is active, verify that a Demand can be converted to a SAFe feature using the **Create SAFe Feature** related link on the Demand form. For more information on how to create an SAFe feature from a demand, see [Create an artifact from a demand](../../it-business-management/demand-management/t_CrtArtftDmdMnu.md).
...
If the PPM Standard plugin \(com.snc.financial\_planning\_pmo\) is active, verify that a Demand can be converted to a SAFe story using the **Create SAFe Story** related link on the Demand form. For more information on how to create a SAFe story from a demand, see [Create an artifact from a demand](../../it-business-management/demand-management/t_CrtArtftDmdMnu.md).
...
If the PPM Standard plugin \(com.snc.financial\_planning\_pmo\) is active, verify that a Demand can be converted to a SAFe epic using the **Create SAFe Epic** related link on the Demand form.For more information on how to create a SAFe epic agile from a demand, see [Create an artifact from a demand](../../it-business-management/demand-management/t_CrtArtftDmdMnu.md).
...
</table>To learn more about Essential SAFe, see [Essential SAFe](../../it-business-management/scaled-agile-framework-safe/essential-overview.md).
...
To learn more about Event Management, see [Event Management](../../it-operations-management/event-management/c_EM.md).
...
</table>To learn more about Audit Management, see [Audit Management](../../governance-risk-compliance/audit-management/c_GRCAudits.md).
...
</table>To learn more about Continuous Authorization and Monitoring, see [Continuous Authorization and Monitoring](../../governance-risk-compliance/continuous-risk-monitoring/grc-cam-landing-page.md).
...
To learn more about Policy and Compliance Management, see [Policy and Compliance Management](../../governance-risk-compliance/policy-and-compliance-management/r_PolicyComplianceMgmt.md).
...
To learn more about Risk Management, see [Risk Management](../../governance-risk-compliance/grc-risk-management-workspace/grc-risk-overview.md).
...
</table>To learn more about Hardware Asset Management, see [Hardware Asset Management](../../it-asset-management/hardware-asset-management/ham-landing-page.md).
...
To learn more about HR Service Delivery, see [HR Service Delivery](../../employee-service-management/hr-service-delivery/hr-service-delivery.md).
...
To learn more about Incident Management, see [Incident Management](../../it-service-management/incident-management/c_IncidentManagement.md).
...
To learn more about Incident Management in Service Operations Workspace, see [Incident Management in Service Operations Workspace](../../it-service-management/service-operations-workspace/incident-sow.md).
...
To learn more about Integration Commons for CMDB, see [Integration Commons for CMDB](../../servicenow-platform/cmdb-integration-commons/integration-commons-for-cmdb.md).
...
</table>To learn more about Investment Funding, see [Investment Funding](../../it-business-management/investment-funding/investment-funding-overview.md).
...
</table>To learn more about Knowledge Management, see [Knowledge Management](../../servicenow-platform/knowledge-management/knowledge-management.md).
...
</table>To learn more about Leader Hub, see [Leader Hub](../../employee-service-management/hr-service-delivery/td-lh-landing.md).
...
To learn more about Legal Request Management, see [Legal Request Management](../../employee-service-management/legal-service-delivery/legal-management-overview.md).
...
To learn more about Major Incident Management, see [Major Incident Management](../../it-service-management/incident-management/major-incident-management.md).
...
To learn more about On-Call Scheduling, see [On-Call Scheduling](../../it-service-management/on-call-scheduling/c_OnCallScheduling.md).
...
</table>To learn more about Metric Intelligence, see [Metric Intelligence](../../it-operations-management/metric-intelligence/operational-metrics.md).
...
</table>To learn more about Problem Management, see [Problem Management](../../it-service-management/problem-management/c_ProblemManagement.md).
...
</table>To learn more about Project Portfolio Management, see [Project Portfolio Management](../../it-business-management/ppm-collaboration/c_ProjectPortfolioSuite.md).
...
To learn more about PPM Standard, see [PPM Standard](../../it-business-management/ppm-collaboration/c_ProjectPortfolioSuiteWithFinancials.md).
...
**Note:** Reporting quick start tests do not test report access from dashboards. To test dashboards, see [Quick start tests for Dashboards](../../now-intelligence/performance-analytics/quick-start-tests-dashboards.md).
...
</table>To learn more about Software Asset Management, see [Software Asset Management](../../it-asset-management/software-asset-management/c_SoftwareAssetMgmt.md).
...
</table>To learn more about Security Incident Response, see [Security Incident Response](../../security-management/security-incident-response/sir-landing-page.md).
...
To learn more about Service Level Management, see [Service Level Management](../../it-service-management/service-level-management/service-level-mgmt-landing-page.md).
...
</table>To learn more about Service Mapping, see [Service Mapping](../../it-operations-management/service-mapping/c_ServiceMappingOverview.md).
...
</table>To learn more about Service Portfolio Management Premium, see [Service Portfolio Management Premium](../../it-service-management/service-portfolio-management/SPM2-landing-page.md).
...
To learn more about Skills Management, see [Skills Management](../../servicenow-platform/skills-management/skills-management.md).
...
To learn more about Test Management 2.0, see [Test Management 2.0](../../it-business-management/test-management/test-management2-landing-page.md).
...
To learn more about Vulnerability Response, see [Vulnerability Response](../../security-management/vulnerability-response/vuln-landing-page.md).
...
To learn more about Walk-up Experience, see [Walk-up Experience](../../it-service-management/walk-up-experience/walkup-experience-landing-page.md).
