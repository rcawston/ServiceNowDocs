...
1.  [Create a skill](../../intelligent-experiences/now-assist-skill-kit/create-new-skill.md) or configure a Now Assist Platform skill for your app's use case.
2.  [Create a prompt](../../intelligent-experiences/now-assist-skill-kit/create-prompt-template.md) to choose what skill inputs to use and the type of tool.
3.  [Test the prompt](../../intelligent-experiences/now-assist-skill-kit/test-prompt-template.md) to verify that you’re seeing the expected prompt results before the skill is activated.
4.  [Evaluate the prompt](../../intelligent-experiences/now-assist-skill-kit/evaluate-prompt.md) to assess the effectiveness of your skill prompts.
5.  [Finalize and publish the skill](../../intelligent-experiences/now-assist-skill-kit/publish-skill.md) to enable a Now Assist admin to activate it.
6.  [Activate the skill](../../intelligent-experiences/now-assist-skill-kit/activate-skill.md), enabling you to trigger the skill within the UI.
...
1.  [Create an AI agent](../../intelligent-experiences/configure-next-best-action-agent.md) or [duplicate an AI agent](../../intelligent-experiences/clone-ai-agent.md) and [modify it](../../intelligent-experiences/modify-ai-agent.md) for your app's use case.
2.  [Add a tool to the AI agent](../../intelligent-experiences/add-tool-aia.md) to enable different functionalities and help your AI agent to achieve their objective.
3.  [Test the AI agent](../../intelligent-experiences/test-ai-agent.md) to see that it functions the way that you defined it.
4.  [Create an agentic workflow](../../intelligent-experiences/configure-use-case-ai-agents.md) or [modify an agentic workflow](../../intelligent-experiences/modify-aia-use-case.md) so that AI agents can coordinate to solve complex problems.
5.  [Test the agentic workflow](../../intelligent-experiences/test-aia-use-case.md) to analyze its performance while it runs the instructions that you defined.
6.  [Evaluate the agentic workflow](../../intelligent-experiences/execute-aia-eval.md) to monitor performance and evaluate it against different benchmarks.
