...
After you add the UI policy, you can configure scripts and the related list actions for it. For more information on client scripts and UI policies, see [Client scripts for UI policies](../../platform-administration/t_CreateAUIPolicy.md).
