...
To see field type descriptions and learn more about what field types you can use, see [Field types](../../platform-administration/r_FieldTypes.md).

To understand the basic field properties and learn more about adding and customizing a field in a table, see [Add and customize a field in a table](../../platform-administration/t_CreatingNewFields.md).
...
To learn how to define a default value for the fields, see [Specify a default field value](../../platform-administration/t_SpecifyingADefaultValue.md).
...
For information on defining function fields, see [Function field](../../platform-administration/platform-support-functions.md).
...
For information on defining reference fields, see [Reference field type](../../platform-administration/c_ReferenceField.md).
...
For information on defining field dependencies, see [Make a field dependent](../../platform-administration/t_MakingAFieldDependent.md).
...
A choice list is a type of field that lets the user select from a pre-defined set of choices. You can define the available choices and customize the behavior and appearance of your choice lists. For information about the choice list configuration, see [Choice list field type](../../platform-administration/c_ChoiceLists.md).
...
A dictionary attribute alters the behavior of the table or element that the dictionary record describes. You can add or modify the dictionary attributes. For information about dictionary attributes, see [Dictionary attributes](../../platform-administration/table-administration-and-data-management/c_DictionaryAttributes.md).
...
Option list of available attributes. Select an option from the list of available attributes.
 ...
 To review the list of available attributes, see [Dictionary attributes](../../platform-administration/table-administration-and-data-management/c_DictionaryAttributes.md).
