...
4.  Select the **security\_admin** role.
    ...
    The security\_admin role grants modification access to high security settings, and allows you to modify the access control list \(ACL\). For more information, see [Elevated privilege roles](../../platform-security/c_ElevatedPrivilege.md).
