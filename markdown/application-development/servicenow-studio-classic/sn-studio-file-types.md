...
[Access control](../../platform-security/instance-security-hardening-settings/sc-access-control.md)
...
Customize system behavior. -   [Business Rules](../../api-reference/business-rules-classic/c_BusinessRules.md) run when a database action occurs \(query, insert, update, or delete\).
-   The script can run:
...
[Email templates](../../platform-administration/c_EmailTemplates.md)
...
[Inbound email actions](../../platform-administration/actions-inbound-email.md)
...
[Map pages](../../platform-user-interface/c_MapPages.md)
...
[Map transforms](../../integrate-applications/system-import-sets/c_CreatingNewTransformMaps.md)
...
[Processors](../../api-reference/scripts/c_Processors.md)
...
[Relationships](../../platform-administration/table-administration-and-data-management/table-relationships.md)
...
[Scheduled script executions](../../platform-administration/time-configuration/c_ScheduledJobs.md)
...
[Schedule items](../../platform-administration/time-configuration/t_ViewAScheduleItem.md)
...
Contain the back-end data for the [System scheduler](../../platform-administration/time-configuration/c_SystemScheduler.md), where scheduled jobs are created, queued up, and executed. Schedule items can execute scheduled jobs, business rules, inactivity monitors, service level agreement \(SLA\) calculations, metric events, upgrades, and more. You can access schedule item records to troubleshoot scheduling.
...
[UI pages](../../api-reference/scripts/r_UIPages.md)
...
[UI style](../../platform-administration/t_DefineFieldStyles.md)
...
[Widgets](../../platform-user-interface/service-portal/c_NestedWidgets.md)
