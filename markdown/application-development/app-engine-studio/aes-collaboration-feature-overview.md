...
Admins must elevate to a security\_admin role to work with collaboration features. For more information, see [Elevated privilege roles](../../platform-security/c_ElevatedPrivilege.md).
