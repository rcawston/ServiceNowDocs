...
Flow with which you can associate the standard catalog item. The flow defines the fulfillment process for the standard catalog item. For more information on flows, see [Flows](../../build-workflows/workflow-studio/flows.md).
