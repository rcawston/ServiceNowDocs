...
5.  Select the kind of mobile experience that you want to add and select **Continue.**
    ...
    -   Mobile Agent
    -   Now Mobile
    For more information about the mobile experience options and important considerations when choosing a mobile experience, see [Design considerations for mobile apps](../../mobile/mobile-design-consideration.md).
...
14. Edit the mobile experience in Mobile App Builder.
    ...
    For more information, see [Mobile App Builder](../../mobile/mab-concept.md).
...
For more information on modifying mobile experiences, see [Mobile App Builder](../../mobile/mab-concept.md).
