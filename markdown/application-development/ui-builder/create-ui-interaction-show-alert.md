...
To trigger this UI interaction from a form or list button using a declarative action, see [Trigger a UI interaction from a declarative action](../../platform-user-interface/configure-da-ui-interactions.md).
