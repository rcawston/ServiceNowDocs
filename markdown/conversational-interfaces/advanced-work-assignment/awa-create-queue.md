...
Base number for the table. For more information, see [Record numbering](../../platform-administration/c_ManagingRecordNumbering.md).
...
Condition that applies to routing work items to this queue.
 ...
 Use the condition builder to select routing conditions. The fields available for selection are based on the selected service channel. For the chat service channel, you can specify chat context variables in the condition builder by [dot-walking](../../platform-user-interface/dot-walking-examples.md) to related context fields.
