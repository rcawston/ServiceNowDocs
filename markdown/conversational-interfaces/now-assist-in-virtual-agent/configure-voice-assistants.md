...
4.  Add one or more AI voice agents to the voice assistant by selecting **Add from library** and select **Save and continue**.
    ...
    **Note:** Add at least one AI voice agent to the voice assistant. The voice assistant uses the AI voice agents to execute AI instructions. You can select an existing agent or select **Create** to create one. See [Create an AI voice agent](../../intelligent-experiences/create-a-voice-enabled-ai-agent.md) for more information.
...
6.  Set up communication channels for the user to interact with the assistant.
    ...
    1.  Integrate a telephony provider to connect to the voice assistant.
        ...
        For more information, see [Integrating voice assistant with CCaaS provider](../../intelligent-experiences/integrating-voice-service-with-ccaas-providers.md).

    2.  Configure your voice assistant to be accessible through mobile app voice launcher function.

        For more information, see [Integrate voice assistant with mobile app voice launcher](../../intelligent-experiences/integrate-voice-assistant-with-mobile-app-voice-launcher.md)
