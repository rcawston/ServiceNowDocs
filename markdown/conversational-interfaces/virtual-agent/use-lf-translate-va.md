...
3.  Select the **Languages** tab.
    ...
    Only languages that are installed and activated are displayed. To learn how to activate localization plugins, see [Activate a language](../../platform-administration/system-localization/t_ActivateALanguage.md).
...
4.  Do one of the following:
    ...
    -   Request translation:
        ...
        2.  When prompted, confirm your choice.
            ...
            A translation record is created, and the translation status changes to **In progress**. The translation task is assigned to a user with the localization fulfiller role. For information about the fulfillment process in the Localization Framework, see [Fulfill a localization task](../../platform-administration/localization-framework/fulfill-localization-task.md).
