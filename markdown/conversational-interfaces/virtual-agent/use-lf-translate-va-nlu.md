...
6.  Click **Manage NLU translations**.
    ...
    The model opens in NLU Workbench. Request translations for your model group. For more information, see [Translate a multilingual model](../../intelligent-experiences/nlu-service/translate-multilingual-model.md).
