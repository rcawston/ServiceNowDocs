...
You must install and configure the Automation Center plugin before using the integration. See [Install Automation Center](../../integrate-applications/automation-center/install-automation-center.md) for more information.

To use the Now Assist feature in the integration, you must install Now Assist for Platform and activate the User Task Step Summarization skill. For more information, see [Install Automation Center](../../integrate-applications/automation-center/install-automation-center.md).
