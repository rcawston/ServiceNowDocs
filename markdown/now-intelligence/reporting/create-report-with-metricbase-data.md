...
You must have the MetricBase product. To get it, see [Requesting the MetricBase product](../../servicenow-platform/metricbase/request-metricbase.md). For more information about MetricBase, see [MetricBase](../../servicenow-platform/metricbase/metricbase.md).
