...
This data visualization is supported on the mobile platform. For more information, see [Pie charts for mobile](../../mobile/mobile-reporting-pie.md) and [Mobile dashboard preview](../../mobile/mobile-dashboard-preview.md).
