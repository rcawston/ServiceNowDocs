...
Standard platform Access Control Lists \(ACLs\) govern access to reports in the reports list. For information about the ACLs used to control access to reports, see [Access control list rules](../../platform-security/access-control/access-control-rules.md).
...
To turn off the automatic marking of reports as favorites, disable the user preference glide.ui.nav.auto\_favorite. For more information, see [User preferences](../../platform-user-interface/c_UserPreferences.md) .
...
Enables you to filter on any condition in platform condition builder format. For example, `https://yourbusiness.service-now.com/report_home.do?sysparm_query=titleSTARTSWITHPRB&table!=incident`. For more information, see [Condition builder](../../platform-user-interface/c_ConditionBuilder.md).
