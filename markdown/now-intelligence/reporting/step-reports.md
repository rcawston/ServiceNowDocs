...
This data visualization is supported on the mobile platform. For more information, see [Time series reports for mobile](../../mobile/mobile-reporting-time-series.md) and [Mobile dashboard preview](../../mobile/mobile-dashboard-preview.md).
...
For a step line report use case, [Time series data visualization example](../dv-example-line.md).
