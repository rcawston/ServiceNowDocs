...
This data visualization is supported on the mobile platform. For more information, see [Donut reports for mobile](../../mobile/mobile-reporting-donut.md) and [Mobile dashboard preview](../../mobile/mobile-dashboard-preview.md).
