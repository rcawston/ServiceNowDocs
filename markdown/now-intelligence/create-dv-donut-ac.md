...
6.  Select the options for your data source.
    ...
    -   If your visualization represents table data, go to [Table data options for pie and donut visualizations](config-dv-donut-table-data.md).
    -   If your visualization represents indicator data, go to [Indicator data options for pie and donut visualizations](config-dv-donut-ind-data.md).
    -   If your visualization represents Usage Insights data, go to [Usage Insights data options for pie and donut visualizations](config-dv-donut-uxa-data.md)
...
-   **[Usage Insights data options for pie and donut visualizations](config-dv-donut-uxa-data.md)**  
