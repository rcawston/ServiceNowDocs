...
6.  Select the options for your data source.
    ...
    -   If your visualization represents table data, go to [Table data options for dial visualizations](config-dv-dial-table-data.md).
    -   If your visualization represents indicator data, go to [Indicator data options for dial data visualizations](config-dv-dial-ind-data.md).
    -   If your visualization represents Usage Insights data, go to [Usage Insights data options for dial data visualizations](config-dv-dial-uxa-data.md).
...
-   **[Indicator data options for dial data visualizations](config-dv-dial-ind-data.md)**  
When you select an indicator data source for a dial visualization, the following Data configuration options are available.
-   **[Usage Insights data options for dial data visualizations](config-dv-dial-uxa-data.md)**  
