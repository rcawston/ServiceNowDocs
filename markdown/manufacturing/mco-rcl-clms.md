...
1.  Configure recall campaign: Complete the following tasks to set up the recall campaign in your environment.
    1.  Install Manufacturing recall claim management \[sn\_rcl\_claim\_mgmt\]: [Installing applications, plugins, and products](../platform-administration/application-manager/installing-apps-app-manager.md).
