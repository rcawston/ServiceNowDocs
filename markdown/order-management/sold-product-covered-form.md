...
-   If an install base item isn't listed, you can add it. Select **New** in the Install Base Item window. For more information, see [Create an install base item](../customer-service-management/create-install-base-item.md).
