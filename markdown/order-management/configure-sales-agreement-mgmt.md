...
As an admin, you can activate the following plugins to enable users to create and manage sales agreements. For more information, see [Activate a plugin](../platform-administration/t_ActivateAPlugin.md).
