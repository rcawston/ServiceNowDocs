...
|------------------|-----------|
|[Create a product offering catalog](som-create-product-catalog.md)|Create a catalog, which is the top-level entity in the catalog hierarchy. Catalogs can have categories, and categories can have subcategories or product offers.|
|[Create a product offering category](som-create-product-offering-category.md)|Define a product offering category used to organize similar product offerings in a catalog. Catalog categories make it easier for agents to browse and navigate product offerings when creating opportunities, quotes, and orders.|
...
|[Create product characteristics and characteristic options](som-product-config-add-characteristics.md)|Define the specific attributes, properties, and options that distinguish a product offering, influencing its configuration and pricing.|
|[Create product offerings](som-create-product-offering.md)|Configure and add product offerings to catalogs and categories. Once published, product offerings are available to Sales Customer Relationship Management agents as they create opportunities, quotes, and orders.|
|[Add product visuals](som-product-config-add-visuals.md)|Add images and thumbnails to your product offerings to help agents as they build opportunities, quotes, and orders.|
...
|[Control cascading quantity values in child product offerings](som-activate-cascade-quantity.md)|Control how the quantities for child line items in a product offering for a quote or order are calculated by using the **sn\_prd\_pm.enable\_cascade\_quantity** system property.|
|[Add related contracts to product offerings](som-product-config-related-contracts.md)|Add related contracts to your product offerings in the Sales Customer Relationship Management application.|
|[Add a unit of measure to a product offering](som-product-config-add-unit-of-measure.md)|Add a unit of measure \(UOM\) to a product offering in Sales Customer Relationship Management.|
|[Create a product offering version](som-product-config-create-new-version.md)|Create a product version to add updates to a published product offering.|
|[Create product offering relationship groups](som-product-config-relationship-groups.md)|Combine bundles of product offerings into related groups in Sales Customer Relationship Management.|
