...
-   Price Band Approver
However, more roles can be configured. Depending on the responsibility, access to the opportunity is provided to the opportunity team members. For more information, see [Create related party configurations](../customer-service-management/adding-related-party-config-to-case.md).
