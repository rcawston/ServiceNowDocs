...
[Create customer accounts](../customer-service-management/import-create-csm-accounts.md)**Note:** On the Accounts form, to view the customer contracts, remove the contract-related lists and configure the customer contracts related list.
...
[Create a consumer record](../customer-service-management/create-a-consumer-record.md)
...
[Create a sold product](../customer-service-management/create-sold-item.md)
