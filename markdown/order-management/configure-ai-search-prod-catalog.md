...
-   **Indexed source**
    ...
    For more information on indexed sources, see [Indexed sources in AI Search](../platform-administration/ai-search/indexed-sources-ais.md).
...
-   **Search source**
    ...
    For more information on search sources, see [Search sources in AI Search](../platform-administration/ai-search/search-sources-ais.md).

-   **Search profiles**

    Search profiles \(Product Offering Search Profile and Service Specification Search Profile\) manage the search experience offered to users and the data to be searched. You can fine tune the synonyms, stop words, typo handling rules used in auto-correction, and result improvement rules that control the product catalog search experience. To learn more about the features that can be changed in a search file, see [Search profiles in AI Search](../platform-administration/ai-search/defining-search-profiles-ais.md).

-   **Search application configurations**

    Search application configurations define the search engine used, the search profile used, and also auto-complete suggestions. For details about these configurations, see [Search application configurations](../platform-administration/ai-search/defining-search-app-cfgs-ais.md).
...
1.  [Install AI Search for Next Experience](../platform-administration/ai-search/install-ais-next-experience-app.md) only if you upgraded from Tokyo or a previous release.
