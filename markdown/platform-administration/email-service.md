...
By default, Email Service only allows admin users to access the [Email API](https://raw.githubusercontent.com/ServiceNow/ServiceNowDocs/australia/markdown/api-reference/rest-apis/email-api.md). Administrators can [grant access to the Email API](grant-access-to-email-api.md) by:
