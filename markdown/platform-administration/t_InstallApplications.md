...
To install an application that you published to the ServiceNow application repository, follow the steps in [Install an application from the application repository](../application-development/application-repository-self-hosted/install-app-from-repo.md) instead.
...
[Install customizations from an application repository](../application-development/application-repository-self-hosted/install-customizations-from-app-repo.md)
