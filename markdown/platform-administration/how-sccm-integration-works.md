...
</table>\*For more information about Software Asset Management and how to enable it, see [Request Software Asset Management](../it-asset-management/software-asset-management/t_RequSoftwareAssetMgmt.md).
...
For more information about CMDB Identification and Reconciliation and IRE, see [CMDB Identification and Reconciliation](../servicenow-platform/configuration-management-database-cmdb/c_CMDBIdentifyandReconcile.md).
