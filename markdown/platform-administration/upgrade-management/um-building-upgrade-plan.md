...
3.  Click **Build** to start the upgrade plan build.
    ...
    Upgrade Plan takes up only the app installations by default and publish it on to the app repository. See Upgrade Plan background operations section in [Upgrade Plans tool in Upgrade Console](um-upgrade-plans-tool.md) for more information.
