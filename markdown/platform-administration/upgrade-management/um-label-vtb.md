...
Click on a skipped record in the VTB to update the task. See [Upgrade History Task form](um-history-task-form.md) for more information.

**Parent Topic:**[Skipped Records visual task board \(VTB\)](um-vtb-history.md)
