...
To learn more about enabling spam scoring and filtering, see [Email spam scoring and filtering \(instance security hardening\)](../platform-security/instance-security-hardening-settings/sc-email-spam-scoring-and-filtering.md) in Instance Security Hardening Settings.
