...
-   [Retrieving and caching external data using remote tables](../../servicenow-platform/remote-tables/remote-tables.md)
-   [Create a remote table](../../servicenow-platform/remote-tables/create-remote-table.md)
...
6.  In the **Application Access** section, define the scope protection for the table.
    ...
    For more information, see [Application access settings](../../application-development/c_ApplicationAccessSettings.md).
...
Select the check box to enable users to make inbound [Web services](../../api-reference/web-services/r_AvailableWebServices.md) web service queries to this table. This option offers both design-time and runtime protection. The user performing the query must have the correct permissions to access this table, even when this check box is selected.
