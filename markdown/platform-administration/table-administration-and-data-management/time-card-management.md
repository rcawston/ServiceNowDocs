...
**Note:** The [Time Card Management plugin](t_ActivateTimeCardManagement.md) is required to use time cards. Some of the procedures require the project management feature, which activates time cards automatically. For more information, see [Project Management](../../it-business-management/project-management/c_ProjectApplicationOverview.md) \(com.snc.financial\_planning\_pmo\).
