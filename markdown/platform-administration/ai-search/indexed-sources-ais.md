...
-   **Internal indexed source**
    ...
    You can't index [remote tables](../../servicenow-platform/remote-tables/remote-tables.md) with internal indexed sources. To index content from a remote table, create an external indexed source.
