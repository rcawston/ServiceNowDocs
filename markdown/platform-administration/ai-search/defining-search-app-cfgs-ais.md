...
Some ServiceNow AI Platform applications install their own AI Search application configurations when you activate them. For example, activating the [Customer Service Management \(CSM\)](../../customer-service-management/c_CustomerServiceManagement.md) application installs AI Search application configurations for the Customer Service Portal and Consumer Service Portal.
