...
For more information on Ask Now Assist suggestions in enhanced chat, see [Enhanced chat](../../conversational-interfaces/now-assist-in-virtual-agent/nava-enhanced-chat.md).
