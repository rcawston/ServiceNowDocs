...
Once enabled, session debugging remains active for the user session until you disable it. For more information on session debugging, see [Session debug](../../api-reference/scripts/c_SessionDebug.md).
