...
Registration lets other parts of the system, such as [Email and SMS notifications](../c_EmailNotifications.md) and Script Actions, see the event in their list of available events and react to the event when it occurs.
