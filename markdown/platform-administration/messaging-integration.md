...
-   **1. Request Integration Hub**
    ...
    The Slack and Microsoft Teams spokes require a Starter subscription to Integration Hub. To activate Integration Hub and view available subscription types, see [Request an Integration Hub plugin](../integrate-applications/integration-hub/request-integrationhub.md).
