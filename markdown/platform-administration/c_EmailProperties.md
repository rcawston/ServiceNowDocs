...
Email accounts are configured in the **System Mailboxes** &gt; **Administration** &gt; **Email Accounts** module. For more information and instructions, see [Create an email account](t_ConfigureAnEmailAccount.md).
