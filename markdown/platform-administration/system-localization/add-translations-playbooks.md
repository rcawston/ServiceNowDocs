...
-   To learn more about translating custom content in general, see [Translating custom content](translating-applications.md).

## About this task

UI Message records are used to translate the text in your playbooks to different languages at runtime, similar to the way system messages are translated on the platform. To learn more about the Message table \[sys\_ui\_message\] in general, see [Message table](r_MessageTable.md).
