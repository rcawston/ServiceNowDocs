...
-   [Translate a client script message](t_TranslateAClientScriptMessage.md)
-   [Internationalize a widget](../../platform-user-interface/service-portal/c_WidgetLocalization.md) in Service Portal documentation
...
[Add translations for Playbooks](../../build-workflows/workflow-studio/add-translations-playbooks.md)
