...
|-----------|----|-----------------|
|Altiris \(version 6.5\)|[MID Server](../servicenow-platform/mid-server/mid-server-landing.md)|CMDB|
|Google Maps|[Web services](../api-reference/web-services/r_AvailableWebServices.md)|Varies|
|Google Custom Search|[Web services](../api-reference/web-services/r_AvailableWebServices.md)|Knowledge|
|Integration — IBM Watson Conversation Service|[Web services](../api-reference/web-services/r_AvailableWebServices.md)|Varies|
|Microsoft SMS / SCCM|[MID Server](../servicenow-platform/mid-server/mid-server-landing.md)|CMDB|
|Verizon eBonding|[Web services](../api-reference/web-services/r_AvailableWebServices.md)|Incident|
...
-   **[Microsoft SCCM integration](c_MicrosoftSCCMIntegration.md)**  
...
-   **[Migrate the Verizon eBonding Integration to a Production System](c_MigrVerizoneBondIntegToAProdSys.md)**  
...
**Parent Topic:**[Integration options](c_IntegrationOptions.md)
