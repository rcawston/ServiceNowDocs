...
See [Outbound REST with OAuth 2.0 profile tutorial - integrating with Google Contacts API](../api-reference/web-services/c_OAuth2ProfileTutorialGoogle.md) for an example of using an OAuth 2.0 profile to authenticate an outbound REST message with Google to retrieve contact information. Also see [OAuth 2.0](../platform-security/authentication/c_OAuthApplications.md) for more information on OAuth 2.0 support in the instance.
