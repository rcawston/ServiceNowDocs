...
Create a JWT signing key to assign to your Java KeyStore \(JKS\) certificate. For more information, see [Configure a JWT signing key](../platform-security/authentication/JWT-Bearer-token-support.md).
