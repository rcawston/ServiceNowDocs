...
-   A reference qualifier named **GetGroupFilter** is available to filter for group types using [Create a dynamic filter option](../../platform-user-interface/t_DynamicFilterOptions.md).
...
You may need to configure the form to display the **Type** field. For more information see: [Personalize a form](../../platform-user-interface/t_PersonalizeAForm.md)
