...
-   **glide.security.auto.resubmit.ajax**: Automatically resubmits timed-out Ajax requests when set to **true** and the [Log in to an instance](../../platform-user-interface/t_LoggingIn.md) check box is selected or [Change the default value of the Remember me check box](../../platform-security/authentication/c_ChSetRemMeChkbxCookie.md). A pop-up appears to users asking them to continue.
