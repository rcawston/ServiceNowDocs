...
Select this check box to [Mark service accounts as internal integration users](../../api-reference/web-services/t_MarkSvcAcctsAsInternalIntegUsers.md).
...
See [Security for AI agents](../../intelligent-experiences/aia-security-implementation.md) for more information on using AI type users.
...
-   2026.08.19
-   2026-08-19
For more information, see [GlideDateTime - Global](../../api-reference/server-api-reference/c_GlideDateTimeAPI.md).
