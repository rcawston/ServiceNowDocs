...
An administrator may need to configure the form to show all the fields listed in the steps. For more information see [Personalize a form.](../../platform-user-interface/t_PersonalizeAForm.md)
