...
You must have a license and get entitlement to Zero Copy Connector for ERP for installation. For more information, see [Licensing](../../application-development/licensing.md).
...
-   Financial Services Remote Tables plugin \(for more information, see [Activate the remote tables plugin](../../servicenow-platform/remote-tables/activate-remote-tables-plugin.md)\)
...
Assign the mid\_user user the sn\_erp\_integration.erp\_mid\_server role. The role enables the [MID Server](../../servicenow-platform/mid-server/mid-server-landing.md) to use the ImportSet API to send data to the ServiceNow instance.
...
**Note:** Create the records at **All** &gt; **MID Server** &gt; **JAR Files**. For more information about creating JAR files and adding attachments, see [Synchronize a JAR file to MID Servers](../../servicenow-platform/mid-server/t_SynchronizeAJARFiletoMIDServers.md).
