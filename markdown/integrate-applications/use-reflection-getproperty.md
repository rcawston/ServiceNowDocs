...
You can configure the properties for the GetProperty component. For more information about these properties, see [Properties of the Reflection components](util-reflection-prop.md).
