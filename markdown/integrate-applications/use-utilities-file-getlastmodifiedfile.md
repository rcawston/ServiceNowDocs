...
You can configure the properties for the GetLastModifiedFile component. For more information about these properties, see [Properties of the File components](util-file-prop.md).
