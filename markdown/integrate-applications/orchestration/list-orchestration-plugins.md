...
Installs the [Active Directory](../../servicenow-platform/orchestration/c_OrchActiveDirectoryActivities.md) activity pack. These activities create, delete, and manage objects in Windows Active Directory.
