...
You can configure the properties for the Min component. For more information about these properties, see [Properties of the Math components](properties-math-component.md).
