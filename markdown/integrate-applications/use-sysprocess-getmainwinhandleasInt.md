...
You can configure the properties for the GetMainWindowHandleAsInt component. For more information about these properties, see [Properties of the System Process components](util-sysprocess-prop.md).
