...
You can configure the properties for the SystemDirectory component. For more information about these properties, see [Properties of the Environment components](util-environment-prop.md).
