...
Retrieves the organization type of the Salesforce instance. To use this action, perform the steps outlined in the Create a Salesforce integration profile section in [Integrating with Salesforce](../../it-asset-management/saas-license-management/integrate-with-salesforce-crm.md).
...
Retrieves user subscription information that is available in Salesforce. To use this action, perform the steps outlined in the Create a Salesforce CRM integration profile section in [Integrating with Salesforce CRM](../../it-asset-management/saas-license-management/integrate-with-salesforce-crm.md).
...
Retrieves the consumption usage details for the resources.To use this action, perform the steps outlined in the Create a Salesforce CRM integration profile section in [Integrating with Salesforce CRM](../../it-asset-management/saas-license-management/integrate-with-salesforce-crm.md).
...
Retrieves user attributes for Salesforce users. To use this action, perform the steps outlined in the Create a Salesforce CRM integration profile section in [Integrating with Salesforce CRM](../../it-asset-management/saas-license-management/integrate-with-salesforce-crm.md).
...
Reclaims a user account in Salesforce. To use this action, perform the steps outlined in the Create a Salesforce CRM integration profile section in [Integrating with Salesforce CRM](../../it-asset-management/saas-license-management/integrate-with-salesforce-crm.md).
...
These actions use REST calls, which can run on an instance or MID Server. Use the connection record associated with the Salesforce alias to configure where actions run as well as set MID Server selection attributes. For more information, see [MID server](../../servicenow-platform/mid-server/mid-server-landing.md).
