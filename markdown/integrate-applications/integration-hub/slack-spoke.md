...
Deactivates a user subscription in Slack. To use this action, perform the steps outlined in the Create a Slack Enterprise Grid application and Create a Slack Enterprise connection section in [Integrating with Slack](../../it-asset-management/saas-license-management/integrate-with-slack.md).
...
Retrieves the access logs for all users since the provided oldest date. To use this action, perform the steps outlined in the Create a Slack workspace application and Create a Slack workspace connection section in [Integrating with Slack](../../it-asset-management/saas-license-management/integrate-with-slack.md).
...
Retrieves all users in the Slack Enterprise grid. To use this action, perform the steps outlined in the Create a Slack Enterprise Grid application and Create a Slack Enterprise connection section in [Integrating with Slack](../../it-asset-management/saas-license-management/integrate-with-slack.md).
