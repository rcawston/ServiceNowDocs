...
-   Enable interoperability with an electronic medical record \(EMR\) or another healthcare system by leveraging the ServiceNow Healthcare and Life Sciences data model that is based on the Health Insurance Portability and Accountability Act \(HIPAA\) and the Health Level Seven International \(HL7\) industry standards. For more information, see [Healthcare and Life Sciences data model](../../healthcare-life-sciences/healthcare-and-life-sciences-service-management-core/hcls-serv-mgmt-core.md).
