...
**Note:** The Retry Handler Framework app is available only as a part of [Microsoft Exchange Online Spoke](ms-exch-online-spoke.md) or [Journey Accelerator](../../employee-service-management/employee-service-management/journey-accelerator.md) app.
