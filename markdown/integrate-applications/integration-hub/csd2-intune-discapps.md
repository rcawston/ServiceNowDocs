...
3.  On the form, fill there values.
    ...
    **Note:** You can use only the default connection and credential alias records that have been shipped along with the [Microsoft Intune Spoke](ms-intune-spoke.md).
...
5.  Click the **Discover Now** related link to discover all applications and retrieve data from the server.
    ...
    The Discover and Store Data subflow is triggered. Data is retrieved and in stored in the [Microsoft Intune Spoke](ms-intune-spoke.md) tables.
