...
You can configure the properties for the IsNullOrWhiteSpace component. For more information about these components, see [Properties of the String Utilities components](util-stringutil-prop.md).
