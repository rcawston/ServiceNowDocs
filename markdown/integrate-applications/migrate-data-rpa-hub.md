...
For more information about update sets, see [Get started with update sets](../application-development/system-update-sets/get-started-update-sets.md).
...
1. [Create and select an update set as the current set](../application-development/system-update-sets/create-select-update-set.md).
...
4. [Mark your current update set complete](../application-development/system-update-sets/t_CompleteUpdateSets.md).
...
5. [Export to XML](../application-development/system-update-sets/t_SaveAnUpdateSetAsAnXMLFile.md).
...
7. Switch to higher instance. [Retrieve an update set](../application-development/system-update-sets/t_RetrieveAnUpdateSet.md).
...
8. [Preview a remote update set](../application-development/system-update-sets/t_PreviewARemoteUpdateSet.md).
...
9. [Commit an update set](../application-development/system-update-sets/t_CommitAnUpdateSet.md).
