...
You can configure the properties for the GetPathRoot component. For more information about these properties, see [Properties of the File components](util-file-prop.md).
