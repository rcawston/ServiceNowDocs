...
-   **[Create a request from an inbound email](t_CreateARequestFromAnInboundEmail.md)**  
...
-   **[Create a request from a forwarded inbound email](t_CreateReqFromAForwInbndEmail.md)**  
...
-   **[Update a request from an inbound email](t_UpdateARequestFromAnInboundEmail.md)**  
