...
The Ignore Travel option does not appear in the work order task form by default so you have to add it manually. For more information, see [Configuring the form layout](../../platform-administration/configure-form-layout.md).
