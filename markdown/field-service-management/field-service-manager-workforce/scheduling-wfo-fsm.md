...
For more information about key performance indicators and sidebars, see [Exploring indicators with KPI Details](../../now-intelligence/kpi-details-components.md).
...
-   Schedule adherence and conformance calculations are based on the formulas, agents' actual and planned work timings. The following are the default formulas that are used to calculate adherence and conformance for agents. However, your administrator can change the [formulas](../../customer-service-management/workforce-optimization-for-customer-service/setup-scheduling-configurable-wfo-cs.md), as required.
