...
If a work order was created from a [work order template](c_WorkOrderTemplates.md), the part requirements are automatically added to the work order task. Part requirements can be used with any [Service Management application](../../service-management-for-the-enterprise/c_ServiceManagement.md).
