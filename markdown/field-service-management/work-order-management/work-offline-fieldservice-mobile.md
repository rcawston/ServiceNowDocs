...
4.  To automatically download the scheduled cache in background, tap the **Enable** button.
    ...
    For more information, see [Scheduled offline caching](../../mobile/scheduled-offline-caching.md).
...
[Updating records without internet connection](../../mobile/offline-end-user.md)
...
[Repair SLAs](../../it-service-management/service-level-management/c_RepairSLAs.md)
