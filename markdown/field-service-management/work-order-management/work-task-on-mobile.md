...
Administrators can enable push notifications in Studio. For information on setting up push notifications, see [Mobile push notifications](../../mobile/sg-mobile-push-notifications.md).
...
[Manage notifications from your mobile device](../../mobile/notification-preference-settings.md)
