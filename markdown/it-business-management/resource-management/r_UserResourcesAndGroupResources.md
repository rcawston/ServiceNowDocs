...
The Resource Manager view in **Resource** &gt; **Resources** &gt; **Users** lists only the users who have the pps\_resource role. In addition to some of the fields displayed in the User Administration &gt; [Users](../../platform-administration/user-administration/t_CreateAUser.md) form, the Resource Manager View &gt; Users form also displays the following fields, which are editable only by a user with resource\_manager role:
