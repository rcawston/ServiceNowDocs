...
[Compare baselines](create-compare-baselines.md#create-and-compare-financial-baselines-for-your-planning-items) to compare the difference in costs between latest status against a baseline or between any two baselines.
