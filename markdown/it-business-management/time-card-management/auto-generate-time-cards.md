...
3.  Configure the following parameters in the script as per the business requirements:
    ...
    **Note:**
    ...
    -   The **Allow time card reporting on** field on the [project form](../project-management/t_CreateAProject.md) determines the level that the time cards for the project tasks are created at.
