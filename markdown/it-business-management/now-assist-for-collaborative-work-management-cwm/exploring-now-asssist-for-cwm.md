...
An administrator can activate and manage Now Assist features and skills for the CWM workspace using the Now Assist Admin console. For more information, see [Overview tab in Now Assist Admin](../../intelligent-experiences/configuring-now-assist.md).

## Now Assist panel in CWM workspace

A knowledge worker can use the Now Assist panel in CWM workspace. This conversational interface enables the user to generate CWM tasks from the context of a Doc page. For more information about the Now Assist panel, see [Now Assist panel](../../intelligent-experiences/now-assist-panel-overview.md).
