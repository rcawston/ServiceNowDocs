...
5.  On the assessment instance form, fill in the fields.
    ...
    For a description of the field names, see [Assessment instance form](assessment-instance-form-dw.md) form.
...
9.  On the Create New Assessment Instance Question form, fill in the fields.
    ...
    For a description of the field names, see [Create assessment instance question form](create-assessment-instance-question-form-dw.md) form.
