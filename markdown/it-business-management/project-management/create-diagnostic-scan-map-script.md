...
-   Create related link for navigating to the diagnostic features and scans in the application. For more information, see [Create a UI action](../../platform-administration/t_EditingAUIAction.md).
