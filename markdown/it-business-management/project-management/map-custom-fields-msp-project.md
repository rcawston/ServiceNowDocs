...
Create custom fields in your ServiceNow instance before mapping them with Microsoft Project. For more information, see [Add and customize a field in a table](../../platform-administration/t_CreatingNewFields.md).
...
-   Configure the Project form to add the custom fields that you want to see. For more information, see [Form configuration](../../platform-administration/basic-form-administration.md).
