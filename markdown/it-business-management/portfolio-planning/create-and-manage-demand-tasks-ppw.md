...
For more information about demand tasks, see [Demand tasks](demand-tasks-ppw.md).
...
5.  On the Create New Demand Task form, fill in the fields.
    ...
    For a description of the field names, see [Create demand task form](create-demand-task-form-ppw.md).
...
[Create demand task form](create-demand-task-form-ppw.md)
