...
2.  Use an existing playbook or create a new one.
    ...
    -   To create a new playbook, define the trigger condition in Workflow Studio. For more information, see [Triggers](../../build-workflows/workflow-studio/process-automation-designer-triggers.md).
    ...
    For more information on how to use playbooks, see [Building Playbooks](../../build-workflows/workflow-studio/building-a-process.md) and [Designing Playbook Experience](../../build-workflows/workflow-studio/playbook-experience-admins.md).
