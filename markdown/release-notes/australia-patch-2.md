...
-   **[Add the Now Assist context menu](../now-intelligence/add-nacm.md)**
...
-   **[Altering tables and fields using dictionary attributes](../platform-administration/table-administration-and-data-management/c_DictionaryAttributes.md)**
    ...
    If true, enables case and accent \(diacritic\) sensitivity for text search of the column. If false, text search of the column is case and accent insensitive. The default behavior is false. This attribute can't be set to true when i18n\_session\_language\_sortable is true on the same column. To learn more see [Set case and accent sensitivity on a per-column basis](../platform-administration/system-localization/sl-locale-text-match.md).

-   **[Guarded script evaluator](../api-reference/scripts/guarded-script.md)**
...
-   **[Install Live Archive](../platform-administration/install-data-archiving-plugin.md)**

    Install Live Archive to archive data in object storage.

-   **[JavaScript APIs supported by guarded script](../api-reference/scripts/guarded-script-allowed-apis.md)**
...
-   **[Live Archive with RaptorDB Professional V2](../platform-administration/data-archiving-with-raptordb-professional-v2.md)**
...
-   **[Review and update scripts incompatible with guarded script](../api-reference/scripts/review-incompatible-guarded-scripts.md)**
...
-   **[Script sandbox environment](../api-reference/scripts/script-sandbox-environment.md)**
...
-   **[Script sandbox evaluator](../api-reference/scripts/script-sandbox.md)**
...
-   **[Set case and accent sensitivity on a per-column basis](../platform-administration/system-localization/sl-locale-text-match.md)**
...
-   **[System Archive](../platform-administration/c_ArchiveData.md)**
...
-   **[Viewing all tables](../platform-administration/data-management-tables.md)**
