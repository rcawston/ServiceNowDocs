...
-   **[Using the interaction and case page for callback request](../../customer-service-management/csm-config-ws-pages-templates.md)**
...
-   **[Using the email interaction page](../../customer-service-management/using-email-interaction-page.md)**
...
-   **Plugins planned for deprecation**
    ...
    -   [Openframe Integration App](../../customer-service-management/c_OpenFrameOverview.md) \(com.sn\_openframe\_integration\)
    -   [Skill Determination](../../customer-service-management/quick-start-tests-csm.md) \(com.snc.skill\_determination\)
    -   [Advanced Work Assignment for CSM](../../customer-service-management/awa-csm-overview.md) \(sn\_csm.awa\)
    -   [Social Media Store](../../customer-service-management/social-media-integration.md) \(sn\_cs\_social\_host\)
...
-   **[IT Service Management](../../it-service-management/r_ITServiceManagement.md)**
    ...
    The following IT Service Management applications can integrate with Customer Service Management: [Incident Management](../../customer-service-management/csm-integration-sm-incident.md), [Problem Management](../../customer-service-management/csm-integration-sm-problem.md), [Change Management](../../customer-service-management/csm-integration-sm-change.md), and [Request Management](../../customer-service-management/csm-integration-sm-request.md). With these integrations, you can create incident, problem, change, and request records from customer service cases. Customers can also submit requests from the Customer Service Portal.
