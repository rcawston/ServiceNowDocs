...
You must have Node.js and Node Package Manager \(npm\) installed to install the ServiceNow SDK. For more information, see [Install the ServiceNow SDK in an application](../../application-development/servicenow-sdk/install-servicenow-sdk.md).
