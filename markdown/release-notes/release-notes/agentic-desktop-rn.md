...
-   **[Use the new application name](../../intelligent-experiences/agentic-desktop-landing-page.md)**
...
-   **[Use the onboarding wizard to get the app overview](../../intelligent-experiences/desktop-actions.md)**
...
-   **[Filter required inputs for testing](../../intelligent-experiences/test-activate-desktop-action-ad.md)**
...
-   **[Improved error and informational messages](../../intelligent-experiences/test-activate-desktop-action-ad.md)**

    Improved error and informational messages for better guidance and troubleshooting during testing of desktop actions.

-   **[Delete button on image canvas](../../intelligent-experiences/agentic-desktop-overview.md)**

    Added a **Delete** button to the image canvas to remove a screen.

-   **[Test button for a screen in the Design tab](../../intelligent-experiences/agentic-desktop-overview.md)**
...
You must first install the supported Now Assist version of ServiceNow to be able to use the Now Assist AI agents. For more information, see [Install Now Assist AI agents](../../intelligent-experiences/install-ai-agents-plugins.md).
