...
-   **[Troubleshoot button alongside the error message on the Integration profile form](../../it-asset-management/now-assist-for-software-asset-management-sam/troubleshooting-saas-now-assist-sam.md)**
...
-   **[Delete button on the Product Workload Mapping form](../../it-asset-management/saas-license-management/integrate-with-crowdstrike.md)**
...
-   **[Product workload mappings and breakdown data lists on the License operations view](../../it-asset-management/software-asset-management/operations-workspace.md)**
...
-   **[Engineering application licenses, usages, and denials lists on the License operations view](../../it-asset-management/software-asset-management/operations-workspace.md)**
