...
-   **[Associate a request header with a resource](../api-reference/rest-api-explorer/associate-header-api-resource.md)**
...
-   **[Associate query parameters with a resource](../api-reference/rest-api-explorer/AssocQueryParmResource.md)**
...
-   **[Automatically generate API request definitions](../api-reference/rest-api-explorer/autogenerate-api-request-definitions.md)**
...
-   **[Common use cases for SQL API](../api-reference/web-services/common-use-cases-for-sql-api.md)**

    The SQL API supports business intelligence reporting, ad-hoc data analysis, and custom report development.

-   **[Configure ServiceNow SQL API JDBC driver on client machine](../api-reference/web-services/configure-jdbc-driver.md)**
...
-   **[Configure ServiceNow SQL API ODBC driver on client machine](../api-reference/web-services/configure-odbc-driver.md)**
...
-   **[Configuring ServiceNow Vault](../platform-security/configuring-servicenow-vault.md)**

    Learn how to install and configure ServiceNow Vault.

-   **[Configuring SQL API](../api-reference/web-services/configuring-sql-api.md)**
...
-   **[Configure SQL API plugin on your ServiceNow instance](../api-reference/web-services/configure-sql-api-overview.md)**

    Configure your ServiceNow instance to enable SQL API access, set up the necessary security controls, and install the appropriate drivers on your client machine.

-   **[Connect DB Visualizer to JDBC driver](../api-reference/web-services/connect-dbvisualizer-jdbc.md)**
...
-   **[Connect Power BI Desktop to ODBC driver](../api-reference/web-services/connect-power-bi-odbc.md)**
...
-   **[Create Access Control Lists \(ACLs\) for SQL API](../api-reference/web-services/create-acls-sql-api.md)**
...
-   **[Create IP filter criteria](../api-reference/web-services/create-ip-filter-criteria.md)**
...
-   **[Create a Service Account and assign Roles](../api-reference/web-services/create-service-account.md)**
...
-   **[Download the SQL API drivers on client machine](../api-reference/web-services/download-sql-api-drivers.md)**

    Download the ODBC and JDBC drivers from the ServiceNow store to your client machine to enable SQL API connectivity.

-   **[Define a REST API response header](../api-reference/rest-api-explorer/define-scripted-api-response-header.md)**

    Define one or more REST API response headers in a REST API.

-   **[Define a REST API schema](../api-reference/rest-api-explorer/define-scripted-rest-api-schema.md)**
...
-   **[Define an API resource request structure](../api-reference/rest-api-explorer/add-schema-rest-api-request.md)**
...
-   **[Define an API resource response structure](../api-reference/rest-api-explorer/add-schema-rest-api-response.md)**

    Add a schema and relevant response headers to a REST response to define the response's expected data structure.

-   **[Define available query parameters](../api-reference/rest-api-explorer/t_DefineAvailableQueryParameters.md)**
...
-   **[Define a scripted REST API request header](../api-reference/rest-api-explorer/t_DefineRESTServiceHeaders.md)**
...
-   **[Getting started with ServiceNow SQL API](../api-reference/web-services/getting-started-with-servicenow-sql-api.md)**
...
-   **[Integrate SQL API Drivers with external BI tools](../api-reference/web-services/configure-drivers-bi-tools.md)**
...
-   **[Install ServiceNow SQL API ODBC driver on client machine](../api-reference/web-services/install-odbc-driver.md)**
...
-   **[Install SQL API plugin on your ServiceNow instance](../api-reference/web-services/install-sql-api-plugin.md)**
...
-   **[Install ServiceNow Vault](../platform-security/install-vault.md)**

    Install the ServiceNow Vault application and assign the required roles.

-   **[Manage connected content from topic pages](../employee-service-management/employee-experience-foundation/mnge-content-topics.md)**
...
-   **[Minimum requirements and supported software for SQL API](../api-reference/web-services/minimum-requirements-and-supported-softwares.md)**
...
-   **[Route SQL API calls to Read Replica](../api-reference/web-services/routing-sql-api-calls-to-read-replica.md)**

    You can route SQL API calls to Read Replica to optimize the performance of your ServiceNow instance.

-   **[Scripted REST APIs](../api-reference/rest-api-explorer/c_CustomWebServices.md)**
...
-   **[ServiceNow Vault roles](../platform-security/vault-roles.md)**

    Learn and set up the roles necessary to use ServiceNow Vault.

-   **[SQL API architecture](../api-reference/web-services/sql-api-architecture.md)**
...
-   **[SQL API reference information](../api-reference/web-services/troubleshooting.md)**

    This section provides details about SQL API reference information like minimum requirements and usage limitations.

-   **[Supported SQL functions](../api-reference/web-services/supported-sql-functions.md)**

    Common SQL functions used in SQL API for querying and analyzing incident data.

-   **[Test SQL API ODBC driver connection using Interactive SQL](../api-reference/web-services/test-sql-api-odbc-driver-connection-using-interactive-sql.md)**
...
-   **[Usage Limitations for SQL API](../api-reference/web-services/usage-limitations.md)**
...
-   **[Use Now Assist to search the CMDB](../servicenow-platform/now-assist-for-configuration-management-database-cmdb/na-cmdb-awf-search.md)**
