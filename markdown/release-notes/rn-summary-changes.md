...
-   **[Optional Application name field](../intelligent-experiences/add-details-desktop-action-ad.md)**
...
-   **[Improved connectors descriptions for non-UI block desktop actions](../intelligent-experiences/desktop-actions-designer-workspace-ad.md)**
...
-   **[Account and Contact field auto-population](../order-management/create-crm-touchpoint.md)**
...
-   **[Unlicensed application information](../platform-administration/application-manager/available-for-you-app-mgr.md)**
...
For more information, see [Business Continuity Management and ServiceNow Store](../governance-risk-compliance/bcm-and-store.md).
...
-   **[Granular instance operator role](../it-asset-management/cloud-cost-management/cloud-insights-roles.md)**
...
-   **[AI filter assist](../platform-user-interface/use-ai-filter-assist.md)**

Convert everyday language into an encoded query with AI filter assist.

-   **[Track record list changes](../platform-user-interface/use-ai-list-tracker.md)**

Get an AI-generated summary of recent changes made to a list without manually reviewing each record.

-   **[Grouping for related lists](../platform-user-interface/configure-related-list-grouping.md)**
...
-   **[Hierarchical queries](../platform-administration/table-administration-and-data-management/data-hierarchies.md)**

Configure a record hierarchy to create filter queries that traverse levels of hierarchy.

-   **[Dynamic queries](../platform-administration/working-with-dynamic-schema.md)**
...
-   **[AI indicator](../platform-user-interface/c_FormFields.md)**
...
-   **[Unsaved field indicator](../platform-user-interface/configure-unsaved-field-indicator.md)**

Configure the unsaved field indicator for your entire workspace experience instead of individual pages.

-   **[Background color for unsaved fields](../platform-user-interface/configure-background-color-unsaved-indicator.md)**
...
-   **[Background color for highlighted values](../platform-user-interface/configure-background-color-highlighted-values.md)**

Configure a background color for fields with highlighted values.

-   **[Text commands for journal fields](../platform-user-interface/configure-journal-fields-keyboard-shortcuts.md)**

Configure text commands that can be applied by keyboard shortcuts within journal fields.

-   **[HTML editor toolbar](../platform-user-interface/configure.md-editor-toolbar.md)**

Configure toolbar options for the HTML editor within journal input fields.

-   **[Inline validation for string fields](../platform-user-interface/format-regex-pattern-string-fields.md)**
...
-   **[Watch lists](../platform-user-interface/configure-watch-list.md)**
...
-   **[Keyboard shortcuts for emails](../platform-user-interface/add-response-templates-shortcut.md)**
...
-   **[Form action layout groups for declarative actions](../platform-user-interface/configure-da-layout-group.md)**
...
-   **[Declarative actions and UI actions on public pages](../customer-service-management/customer-self-service-and-omnichannel-engagement/using-web-embeddables.md)**
...
-   **[Enhanced Customer Data Viewer role](../customer-service-management/business-stakeholder-for-csm.md)**
...
-   **[Household plugin migration to ServiceNow Store](../customer-service-management/activate-customer-service-household.md)**
...
-   **[Guided setup access for granular admin roles](../customer-service-management/import-csm-accounts.md)**
...
-   **[Extensible account code support](../customer-service-management/csm-account-code-account-path.md)**
...
-   **[Declarative Responsibility Framework enhancements](../customer-service-management/declarative-resposibility-framework.md)**
...
-   **[Unified User configuration enhancements](../customer-service-management/configuring-unified-user.md)**
...
-   **[Install base data model enhancements](../customer-service-management/create-install-base-item.md)**
...
-   **[Service Model Foundation renamed Entities](../customer-service-management/renamed-entities.md)**
...
-   **[Enhanced JFrog integration with DevOps Change Velocity](../it-service-management/devops-change-velocity/devops-jfrog-connect-workspace.md)**
...
-   **[Bearer authentication in JFrog](../it-service-management/devops-change-velocity/devops-jfrog-connect-workspace.md)**

Connect to JFrog using the secure bearer token authentication to comply with JFrog’s updated security policies.


-   **[HTTP proxy for Docker](../it-service-management/devops-change-velocity/servicenow-custom-actions-for-gitlab.md)**
...
-   **[Health scan enhancements](../it-service-management/devops-change-velocity/run-health-scan-check.md)**
...
-   **[Auto close without Change Management - State Model \[Legacy\] plugin](../it-service-management/devops-change-velocity/dev-ops-change-acceleration.md)**
...
-   **[Enhanced SLA Definitions for Reg E and Reg Z](../financial-services-operations/dispute-management/using-the-dispute-content-pack-for-us-regulation.md)**
...
-   **[Sitemap support in the Webcrawler external content connector](../platform-administration/ai-search/webcrawler-external-content-connector.md)**
...
-   **[Start point links for scheduled partial content crawls](../platform-administration/ai-search/create-content-crawl-external-content-connector.md)**
...
-   **[Start point links in partial content crawl history entries](../platform-administration/ai-search/review-crawl-ext-cont-connector.md)**

View the start point for a scheduled partial content crawl via a link in its crawl history entries.

-   **[Limited Role-Based Access Control \(RBAC\) support in the Atlassian](../platform-administration/ai-search/atlassian-confluence-cloud-external-content-connector.md) Confluence Cloud external content connector**
...
-   **[Automated document submission in Mastercard transaction dispute process](../financial-services-operations/dispute-management/chargeback-stage-mastercard.md)**
...
-   **[New subflow and action to support Card data security](../financial-services-operations/dispute-management/card-data-security.md)**
...
-   **[Cancel translation requests, delete draft requests, and review archived requests from the landing page](../platform-administration/localization-workspace/lw-status-synchronization.md)**
...
-   **[View the translation method from the translation request summary](../platform-administration/localization-workspace/lw-status-synchronization.md)**
...
-   **[Use intelligent due date suggestions based on the size and scope of your requests](../platform-administration/localization-workspace/lw-estimate.md)**
...
-   **[Summarize a legal request or matter by using Now Assist for Legal Service Delivery \(LSD\)](../employee-service-management/now-assist-for-legal-service-delivery/now-assist-lsd-summarize-case.md)**
...
-   **[Configure use case mappings for metadata and obligation extraction](../employee-service-management/contract-management-pro/cmpro-na-usecase-mappings-me.md)**
...
-   **[Conversational contract search and insights Workflow](../employee-service-management/contract-management-pro/cmpro-agentic-use-conv-search.md)**
...
-   **[Now Assist in Document Intelligence skills are now turned on by default](../intelligent-experiences/now-assist-skills/now-assist-skills-on-by-default.md)**
...
-   **[Changes to limitations](../intelligent-experiences/now-assist-in-document-intelligence/now-assist-document-intelligence-limitations.md)**

The file size limit for uploading a file using the attachment summarization feature is changed from 10MB to 20MB.

-   **[Add a tool](../intelligent-experiences/now-assist-skill-kit/add-a-tool.md)**
...
-   **[Explore data from protected scopes](../now-intelligence/enable-aide-secure-scope-apps.md)**
...
-   **[Improvements to how segments are handled](../now-intelligence/querygen-segments.md)**
...
-   **[Customize semantic metadata in configuration tables](../now-intelligence/customize-semantic-metadata.md)**
...
-   **[View recommended actions](../now-intelligence/expl-view-recommended-actions.md)**

AI Data Explorer can suggest actions based on the insights that it generates in an exploration.

-   **[Ask questions about FX currency data](../now-intelligence/qg-supported-query-operations.md)**
...
-   **[Benefit from improvements to segments](../now-intelligence/querygen-segments.md)**
...
-   **[Demand summarization skill enhancements](../it-business-management/demand-management/demand-summary-demand-classic.md)**
...
-   **[Customer Service Portal Base](../customer-service-management/customer-self-service-and-omnichannel-engagement/configure-csm-service-portals.md)**
...
-   **[Subscriptions and Activity Feed Framework](../api-reference/rest-apis/actsub-api.md)**
...
-   **[Walk-Up for CSM](../customer-service-management/customer-self-service-and-omnichannel-engagement/csm-walkup-experience.md)**
...
-   **[Flow API supports Service Catalog triggers and actions](../application-development/application-development/fluent-flow-api.md)**

Use triggers and actions related to Service Catalog with the Flow API.

-   **[Access Control List API supports protection policies](../application-development/servicenow-sdk/acl-api-now-ts.md)**

Control whether someone can view or edit an access control list \(ACL\) with the protectionPolicy property in an ACL object.

-   **[Keys updated for static assets in full-stack applications](../application-development/building-applications-source-code.md)**
...
-   **[Preview an app file in ServiceNow Studio](../application-development/servicenow-studio-classic/preview-app-file.md)**
...
-   **[Integrated tab groupings](../application-development/servicenow-studio-classic/qs-open-apps-files-across-scopes.md)**
...
-   **[Granular configuration admin roles](../it-asset-management/software-asset-management/sam-installed-components.md)**
...
-   **[Apache Iceberg primary connector](../integrate-applications/apache-iceberg-primary-zcc.md)**

The Apache Iceberg connector is now certified as a primary connector.

-   **[Primary connectors in preview](../integrate-applications/primary-connectors-zcc.md)**
...
[Amazon S3 Tables connector — Preview](../integrate-applications/primary-connectors-zcc.md)
...
[Apache Iceberg connector — Preview](../integrate-applications/primary-connectors-zcc.md)
...
[Teradata](../integrate-applications/teradata-zcc.md)

The Teradata connector now supports Bearer Token and OAuth authentication methods.

-   **[Australia Patch 2](australia-patch-2.md)**

[Apache Iceberg](../integrate-applications/apache-iceberg-primary-zcc.md)
