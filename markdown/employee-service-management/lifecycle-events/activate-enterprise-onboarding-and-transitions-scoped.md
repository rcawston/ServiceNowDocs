...
-   **Using Playbook with Lifecycle Events**
    ...
    **Note:** For more information on requesting a ServiceNow Store plugin, see [Install a ServiceNow Store application](../../platform-administration/t_InstallApplications.md).
