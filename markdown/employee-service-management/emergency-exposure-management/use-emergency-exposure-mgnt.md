...
-   **[Field Service Management](../../field-service-management/t_ActivateFieldServiceManagement.md) \(com.snc.work\_management\)**
...
-   The manager of the affected field agents can take further actions such as blocking their future work order assignments. For more information, see [Emergency Exposure Management for field service agents](../../field-service-management/monitoring-analytics-fsm.md) .
