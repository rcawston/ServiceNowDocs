...
-   Surveys are built with the ServiceNow® Survey designer. So, familiarize yourself with [Survey administration](../../servicenow-platform/r_SurveyAdminTasks.md).
-   Ensure that the application scope is selected as Health and Safety Risk Management. For more information, see [Application picker](../../application-development/c_ApplicationPicker.md).
...
2.  Create a new survey or modify an existing one.
    ...
    -   For information on building and updating surveys, see [Survey designer](../../servicenow-platform/c_SurveyDesigner.md).
