...
You can customize the widgets to display relevant metrics by using the UI Builder. For more information, see [UI Builder tutorial](../../application-development/ui-builder/uib-tutorial.md).
