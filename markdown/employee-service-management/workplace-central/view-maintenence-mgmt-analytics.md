...
</table>You can also add new indicators. For more information on how to work with indicators, see [Configure Performance Analytics fundamentals](../../now-intelligence/performance-analytics/c_PAWidgetsAndDashboards.md).
