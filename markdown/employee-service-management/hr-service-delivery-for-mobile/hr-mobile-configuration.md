...
-   Search
    -   People search
        -   Note: Customers that do not use the Employee Center \(EC\), the base system people search configuration is used. For more information, see [Mobile search](../../mobile/sg-mobile-search.md).
