...
Response templates are reusable messages that can be used by the legal fulfillers to respond to stakeholders of a legal request or legal matter. For more information, see [Response templates](../../servicenow-platform/response-templates-templated-snippets.md).
