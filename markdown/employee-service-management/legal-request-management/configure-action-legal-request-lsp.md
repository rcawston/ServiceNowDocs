...
-   The Actions is one of the sections of a standard ticket page of the Service Portal, so get familiar with the [Standard ticket page](../../platform-user-interface/service-portal/standard-ticket-page.md) and [Service Portal](../../platform-user-interface/service-portal/c_ServicePortal.md).
-   For more information about configuring service portal widgets, see [Service Portal widgets](../../platform-user-interface/service-portal/service-portal-widgets.md).
-   For more information about using and customizing the script includes, see [Script includes](../../api-reference/scripts/c_ScriptIncludes.md).
