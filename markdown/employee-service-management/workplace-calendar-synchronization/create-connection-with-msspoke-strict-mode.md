...
1.  Install Microsoft Exchange Online spoke from the ServiceNow Store. For more information, refer to [Microsoft Exchange Online spoke](../../integrate-applications/integration-hub/ms-exch-online-spoke.md).
