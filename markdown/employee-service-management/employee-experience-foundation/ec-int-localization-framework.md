...
-   \(Optional\) Configure a translation mode, such as machine translations, send to a translation management system, send via email, or export/import: [Translation modes](../../platform-administration/localization-framework/translation-modes.md).
-   Create a user group to perform translation:
    ...
    -   Assign the `localization_fulfiller` role to the group: [Assign a role to a group](../../platform-administration/user-administration/t_AssignRoleToGroup.md)
    -   Add users to perform translation: [Add a user to a group](../../platform-administration/user-administration/t_AddAUserToAGroup.md)
