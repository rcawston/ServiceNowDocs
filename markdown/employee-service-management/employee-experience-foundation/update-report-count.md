...
2.  On the scheduled jobs page, select the **Populate Manager Reportee Count Using Eligible Users** job.
    ...
    **Important:** If the [Domain Separation plugin](../../platform-security/domain-sep-plugin.md) is activated on your instance, select the **Populate Manager Reportee Count Using Eligible Users \[Domain Separated\]** job.
