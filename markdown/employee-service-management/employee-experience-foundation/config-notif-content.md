...
2.  Select **New Provider Content** and select **Portal Content** to create portal notification content.
    ...
    -   **Workspace**
    -   **Next Experience**
    For more information on setting up different types of notification content, see [Provider notifications](../../platform-administration/provider-notifications-landing.md).
