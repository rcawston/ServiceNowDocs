...
To enable a survey in the email channel, the [email notification](../../platform-administration/t_CreateANotification.md) and the [survey](../../servicenow-platform/r_SurveyManagementLandingPage.md) must be selected in the [feedback definition](config-feedback-dfnition.md) for the required workflow.
