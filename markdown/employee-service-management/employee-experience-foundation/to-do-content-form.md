...
The e-signature template used with the e-signature content type. **Note:** For more information, see [Configure an e-signature template](../../servicenow-platform/e-signature/configure-e-signature-configuration.md).
