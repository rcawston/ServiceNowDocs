...
4.  Select **Link to ServiceNow** to authenticate.
    ...
    **Note:**
    ...
    The administrator can auto-link the ServiceNow user accounts to Microsoft Teams. For more information, see [Account linking in pre-built messaging integrations](../../conversational-interfaces/virtual-agent/va-adapter-autolinking.md).
