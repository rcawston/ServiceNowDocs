...
The approval flows are built on [Flow Designer](../../application-development/flow-designer.md). Before modifying, make sure that you're familiar with the basics of ServiceNow® Workflow Studio.
