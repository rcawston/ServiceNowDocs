...
-   The Now Mobile app is built using ServiceNow Mobile App Builder, so make sure you’re familiar with the [Mobile App Builder](../../mobile/mab-concept.md) basics.


For more information about configuring a tab on the navigation bar of Now Mobile app, see [Configure the navigation bar and navigation tabs](../../mobile/config-sg-application-menu.md).
