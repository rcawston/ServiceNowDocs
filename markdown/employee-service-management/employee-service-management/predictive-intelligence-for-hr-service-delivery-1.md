...
-   **[Auto determination of HR service](../hr-service-delivery/predict-hr-service.md)**  
...
-   **[Auto determination of assignment group](../hr-service-delivery/predict-assignment-group.md)**  
...
-   **[Discovering knowledge articles and catalog items for employees](../hr-service-delivery/user-profile-based-recommendations.md)**  
...
-   **[Discovering similar knowledge articles for HR cases](../hr-service-delivery/train-model-articles-hr.md)**  
...
-   **[Discovering similar closed cases for HR cases](../hr-service-delivery/train-model-closed-caseshr.md)**  
Help an HR agent resolve the current case by displaying similar closed cases.
-   **[Displaying related knowledge articles for completing tasks](../hr-service-delivery/display-articles-employee-portal.md)**  
...
**Parent Topic:**[Integration of HR Service Delivery with ServiceNow applications](../hr-service-delivery/integrate-hr-platform-apps.md)
