...
For more information on requesting activation of a plugin, see [Request a plugin](../../platform-administration/t_RequestAPlugin.md).
...
**Note:** The Explicit Roles \(com.glide.explicit\_roles\) plugin must be activated before activating the Alumni Center \(sn\_asc\). For information on installing a ServiceNow Store application, see [Install a ServiceNow Store application](../../platform-administration/t_InstallApplications.md).
...
-   **Load data**
    ...
    To add alumni users in bulk, use **System Import Sets**. For more information, see [Import sets key concepts](../../integrate-applications/system-import-sets/c_ImportSetsKeyConcepts.md).
