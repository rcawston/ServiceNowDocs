...
Refer to [Create rules to route and assign customer service cases](../../customer-service-management/c_CaseRouting.md) for more information on matching and assignment rules.
