...
-   **Flow**: The flow option enables you to select an existing sub-flow from the application. For more information about Flows, see [Flows](../../build-workflows/workflow-studio/flows.md).
