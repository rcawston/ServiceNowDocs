...
1.  Install the Now Assist for HR Service Delivery \(HRSD\) plugin \(sn\_hr\_gen\_ai\).
    ...
    **Note:** For information about the plugin dependencies and plugin activation order, see [Supporting information for Now Assist for HRSD](support-info-hr-assist.md).For information about the installation process, see [Install Now Assist plugins](../../intelligent-experiences/install-now-assist-feature-plugins.md).
