...
For global search and Employee Center, you must enable Q&amp;A Genius Results manually. For more information, see [Enabling Now Assist Q&amp;A Genius Results](../../platform-administration/ai-search/enabling-now-assist-qa-grs.md) and [Enable Now Assist genius results](../employee-experience-foundation/na-qa-activate.md).

For more information on the other supported search engines, see [Search in Legal Service Delivery](../legal-service-delivery/lsd-search-overview.md).
