 ...
 **Note:** [Inbound mail configuration](../../platform-administration/r_InboundMailConfiguration.md). If you need to perform filtering on inbound emails, see [Email filters](../../platform-administration/c_EmailFilters.md).
