...
-   With the [Emergency Outreach](../emergency-outreach/emergency-outreach.md) application, notify employees of important information about anticipated or occurring emergency situations. Send an outreach notification via email, mobile push message, or SMS message to request an employee response. You can also configure other preferred communication channels.
...
-   **[Install Employee Health Screening](install-emp-health-screening.md#)**  
...
-   **[Configure Employee Health Screening](configure-health-screening.md#)**  
...
-   **[Add message for users during health screening](add-screening-information-message.md)**  
...
-   **[Verify your health status and compliance](agree-compliance-return.md)**  
...
-   **[Conduct a health screen for entry](screen-returning-employee.md)**  
...
-   **[Screen a visitor for entry to the workplace](screen-visitor.md)**  
...
-   **[Monitor progress with the Employee Health Screen Overview dashboard](view-health-screen-dashboard.md)**  
...
-   **[View entry requests](view-entry-requests.md)**  
