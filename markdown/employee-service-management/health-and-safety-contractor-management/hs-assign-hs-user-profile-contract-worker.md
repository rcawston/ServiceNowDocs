...
Confirm that the snc\_external role is assigned to the contractor worker. For more information on this explicit role, see [Explicit Roles](../../platform-security/explicit-roles.md).
