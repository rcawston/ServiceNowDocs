...
View [Subflow-agent mapping for HR Service Delivery Integration with SuccessFactors](sf-agent-mapping.md).
...
3.  Configure the [SuccessFactors Spoke](../../integrate-applications/integration-hub/successfactors-spoke.md) to pull data from SuccessFactors system.
