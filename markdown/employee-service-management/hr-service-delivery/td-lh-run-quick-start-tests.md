...
2.  Search and select the quick start tests you want to run.
    ...
    For information on available quick start tests, see [Quick start tests for Leader Hub](quick-start-tests-leader-hub.md).
...
**Parent Topic:**[Quick start tests for Leader Hub](quick-start-tests-leader-hub.md)
