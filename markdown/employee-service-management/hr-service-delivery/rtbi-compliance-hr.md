...
Customers can choose to anonymize the employees personal data over deletion. For more information, see [Data anonymization](../../platform-security/data-privacy-classic/dps-data-anonymization.md).

The ServiceNow platform offers other tools like Table cleaner, Archival rules, and Destroy rules, to support minimal data retention by removing outdated data. For more information, see [Exploring Data Management](../../platform-administration/exploring-data-management.md). For enhanced data privacy, you can explore Anonymization and Field Encryption. For more info, see [Field Encryption](../../platform-security/field-encryption.md).
