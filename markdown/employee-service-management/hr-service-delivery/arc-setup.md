...
You must also set up an enterprise Google captcha account. For more information, see [Configure Google reCAPTCHA for the password reset process](../../servicenow-platform/password-reset/t_ConfigureGoogleRecaptcha.md).
