...
For more detailed information about working with surveys, trigger conditions, and survey questions, see [Get started with Survey Management](../../servicenow-platform/r_SurveyManagementLandingPage.md).
