...
2.  Configure HR Multi Instance Integration for Consumer by performing the following steps:
    1.  Register a service bridge provider. For more information, see [Connect to a provider](../../service-exchange/service-bridge-v2-register.md).
    2.  Activate remote record producers that the provider has published for your organization. For more information, see [Activate a remote record producer in Service Exchange](../../service-exchange/service-bridge-v2-activate-entitlements.md).
