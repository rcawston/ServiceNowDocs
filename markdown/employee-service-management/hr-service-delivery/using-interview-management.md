...
-   Use Microsoft Outlook Calendar to schedule an interview.
    ...
    -   To use this feature, you must integrate with Microsoft Exchange. Ensure the **sn\_hr\_er.ex\_online\_notification\_url** system property contains the Callback URL in the **Value** field. For more information, see [Set up Microsoft Exchange Online spoke](../../integrate-applications/integration-hub/setup-ms-exch-ol.md).
