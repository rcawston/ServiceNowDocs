...
3.  Complete the form.
    ...
    **Note:** Some fields were eliminated for HR. See [Modify a survey definition](../../servicenow-platform/t_ModifySurveyDefinitions.md) for more information.
