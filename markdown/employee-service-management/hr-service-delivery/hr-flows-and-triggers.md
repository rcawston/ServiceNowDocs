...
-   **Case Trigger Custom Condition**
    ...
    This flow can be used as a template to create a customized trigger. The trigger is based on a custom date check for the employee start date. The default trigger is initiated two days prior to the employee start date. For more information about flows and triggers, see [Flows](../../build-workflows/workflow-studio/flows.md).
