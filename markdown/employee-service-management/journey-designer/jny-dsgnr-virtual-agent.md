...
You can also associate other actions with the notifications. For more information, see [Add actions to the notification content](../../platform-administration/noti-select-provider-actions-order.md).
