...
Provides an immediate insight from your existing contract request data.
 ...
 For more information on running historical data collection jobs, see [Collect historical data](../../now-intelligence/performance-analytics/t_RunHistoricalDataCollection.md).
