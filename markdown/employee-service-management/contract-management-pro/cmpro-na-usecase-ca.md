...
Language of the contract documents this is by Now Assist.For more information on supported languages, see [Languages supported by Document Intelligence](../../intelligent-experiences/document-intelligence/languages-supported-by-document-intelligence.md).
...
This field should be left empty.
    ...
    4.  Enter details for the field.
        ...
        For more information on the field form, see [Question form for use case setup](../../intelligent-experiences/now-assist-in-document-intelligence/document-qna-single-field-form.md).
