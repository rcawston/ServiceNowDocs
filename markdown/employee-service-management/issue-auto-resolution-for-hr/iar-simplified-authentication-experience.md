...
To learn more about time-limited authentication, see [Time limited authentication](../../platform-security/authentication/time-based-authentication-with-mfa.md).
