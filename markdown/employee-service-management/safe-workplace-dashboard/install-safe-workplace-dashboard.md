...
For information about customizing Service Portal widgets, see [Service Portal widgets](../../platform-user-interface/service-portal/service-portal-widgets.md) and the [Widget developer guide](../../platform-user-interface/service-portal/widget-dev-guide.md).
...
For information about using Performance Analytics, see [Performance Analytics](../../now-intelligence/performance-analytics/pa-overview.md).
