...
The Exposure Case Task Survey is available for contact tracers to use to assess the health status of the exposed contact. The administrator can review and modify the survey. For more information, see [Survey designer](../../servicenow-platform/c_SurveyDesignerElements.md).
