...
The **Automated Case Creation from Employee Self Report** flow is installed with Contact Tracing. The contact tracing admin can review and configure the base system flow using the [Flow Designer](../../application-development/flow-designer.md).
