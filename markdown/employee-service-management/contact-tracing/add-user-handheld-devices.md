...
You can also import your handheld computing devices data from an Excel spreadsheet that you use with the Zebra MotionWorks software. For more information, see [Easy import data from a list](../../integrate-applications/easy-import/c_EasyImport.md).
