...
The employee daily contact log in the Contact Tracing application works with the Emergency Outreach application. For more information, see [Emergency Outreach](../emergency-outreach/emergency-outreach.md).
...
-   **[Submit a list of contacts that you interacted with at the workplace](submit-contacts-log.md#)**  
...
-   **[Review daily log responses](review-daily-contacts-log.md)**  
