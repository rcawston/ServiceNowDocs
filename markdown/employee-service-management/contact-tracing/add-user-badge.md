...
You can also import your user badge data from an Excel spreadsheet. For more information, see [Easy import data from a list](../../integrate-applications/easy-import/c_EasyImport.md).
