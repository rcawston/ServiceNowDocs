...
**Note:** To enable AI search for Workplace Service Delivery for Mobile, you need to request for AI search and activate AI search. For more information about how to install and configure AI Search, see [AI Search](../../platform-administration/ai-search/overview-ais.md).
