...
1.  Upload an image to your instance to use as a placeholder. For details on uploading images, see [Storing images in the database](../platform-user-interface/c_StoringImagesInTheDatabase.md)
