...
User role records are stored in the Roles \[sys\_user\_role\] table. For more information, see [Managing roles](../platform-administration/user-administration/ua-creating-roles.md).
