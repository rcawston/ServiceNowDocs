...
-   [System Localization](../platform-administration/system-localization/system-localization-landing.md)
-   [Localization Workspace](../platform-administration/localization-workspace/localization-workspace.md)
-   [Translated Name / Field table](../platform-administration/system-localization/r_TranslatedNameFieldTable.md)
-   [Artifact configurations](../platform-administration/localization-framework/framework-configuration.md)
-   [Create and configure a custom artifact](../platform-administration/localization-framework/create-configure-custom-artifact.md)
...
-   [ServiceNow Store](../platform-administration/servicenow-store.md)
-   [Get a free application](../platform-administration/get-free-app.md)
