...
Indicates whether the AI model is in a draft, development, or deployed state. For more information on states, see [AI asset lifecycle](../../intelligent-experiences/ai-control-tower/ai-asset-lifecycle.md).
