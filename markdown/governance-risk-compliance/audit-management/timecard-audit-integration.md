...
When an audit user logs time using time cards, the time cards are sent for approval based on the approvers defined in the time sheets policy. To learn more about time sheets policy, see [Time sheet policy](../../it-business-management/time-card-management/time-sheet-policies.md)
...
To create a time card, see [Create a time card](../../it-business-management/time-card-management/t_CreateATimeCard.md).

A user can submit the time cards through the time sheet portal directly without coming to the engagement. To submit a time card, see [Submit a time card](../../it-business-management/time-card-management/submit-time-card.md). To submit a time card from the time sheet portal, see [Submit time card from the time sheet portal](../../it-business-management/time-card-management/create-timecards-through-worker-portal.md)
