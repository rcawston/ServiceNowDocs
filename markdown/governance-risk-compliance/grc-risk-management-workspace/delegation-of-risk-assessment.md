...
As a risk assessor, to understand how you can assign a delegate, refer to [Configure a delegate for your tasks](../../servicenow-platform/self-service/t_DelegateApprovalsTasks.md).

To delegate tasks to another user, configure your user profile form to display the Delegates related list. For details, refer to [Add the Delegates related list](../../servicenow-platform/self-service/add-delegates-related-list.md).
