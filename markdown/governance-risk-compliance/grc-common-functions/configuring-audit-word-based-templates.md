...
[Configure templates for Document Designer](configure-template-for-document-designer.md)

Configure the template to specify the fields from which data must be obtained and displayed on the audit report.

[Create data relationships](create-data-relationships.md)
...
[Create content configurations](create-content-configurations.md)
...
[Create an audit report template using ServiceNow Document Designer](create-an-audit-report-template.md)
