...
-   **Establish a connection with cloud hosting services**
    -   **Connection with Microsoft OneDrive**
        ...
        You must first set up the Microsoft OneDrive to perform actions in Microsoft OneDrive from ServiceNow. For more information, see [Setup Microsoft OneDrive for Document Services](../../servicenow-platform/document-management-services/configure-ms-onedrive-doc-services.md).
    ...
    -   **Connection with Microsoft SharePoint**
        ...
        You must first set up the Microsoft SharePoint to perform actions in Microsoft SharePoint site from ServiceNow. For more information, see [Setup Microsoft OneDrive for Document Services](../../servicenow-platform/document-management-services/configure-ms-onedrive-doc-services.md).
    ...
    -   **Connection with Google Drive**
        ...
        1.  [Set up Google Drive spoke](../../integrate-applications/integration-hub/setup-gdrive.md) account.
        2.  Integrate the Document Services with Google Drive. For more information, see [Document Services Framework for Google Drive](../../servicenow-platform/document-management-services/google-drive-spoke-document-services.md).
        3.  To manage documents in Google Docs from your ServiceNow instance, you must integrate the ServiceNow instance with Google docs. For more information, see [Set up the Google Docs](../../integrate-applications/integration-hub/setup-gdocs.md).
