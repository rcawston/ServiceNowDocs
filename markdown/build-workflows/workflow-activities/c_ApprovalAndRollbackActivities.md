...
-   With two exceptions, approval and rollback activities are only available when the workflow runs on a table that extends Task. The exceptions are the [**Approval - User**](../../servicenow-platform/workflow-activities/r_ApprovalUser.md) and [**Approval Action**](../../servicenow-platform/workflow-activities/r_ApprovalAction.md) activities, which are available globally.
