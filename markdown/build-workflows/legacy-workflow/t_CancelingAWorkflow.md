...
3.  Configure form layout to add **On-cancel script** field to form.
    ...
    For detailed information about configuring form layout, see [Configuring the form layout](../../platform-administration/configure-form-layout.md).
...
For more information, see the [Workflow - cancelContext\(GlideRecord context\)](../../api-reference/server-api-reference/c_Workflow_api.md).
