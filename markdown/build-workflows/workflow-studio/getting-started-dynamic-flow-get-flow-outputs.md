...
8.  In the Flow header, select **Activate** to make your flow accessible within the Cloud Instance Provisioning [Application scope](../../application-development/c_ApplicationScope.md).
