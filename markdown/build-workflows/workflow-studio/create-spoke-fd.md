...
19. Click **Done: Go to spoke** to go the Spokes page and view the publish status.
    ...
    -   Actions with the OpenAPI step are created. For information about the OpenAPI step, see [OpenAPI support in the REST step](../../integrate-applications/integration-hub/open-api-integration.md).
