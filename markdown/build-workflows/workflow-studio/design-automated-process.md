...
-   Ensure that your current application is set to **Global**. For more information, see [Application picker](../../application-development/c_ApplicationPicker.md).
...
1.  Create a playbook named **Handle Interactions with VIPs**.
    ...
    9.  Use the [condition builder](../../platform-user-interface/c_ConditionBuilder.md) to add the following condition to your trigger:
...
4.  Add the **Wait for assignee to update** activity to the **Communicate Work in Progress** stage.
    ...
    11. Use the [condition builder](../../platform-user-interface/c_ConditionBuilder.md) to add the following condition to your activity:
