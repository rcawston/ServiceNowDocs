...
The system removes these records in 28 days when the table is rotated or when it removes the context record, whichever comes first.
 ...
 The table rotation on sys\_flow\_log is configurable. For more information, see [Table rotation](../../platform-administration/c_TableRotation.md).
