...
-   **Output**
    ...
    JSON payload as a string. If you want to use the payload as an object, you can use the [JSON parser step](../../integrate-applications/integration-hub/json-parser-step-action-designer.md) to parse the string.
