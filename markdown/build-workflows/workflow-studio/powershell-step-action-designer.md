...
Button to test the configured credential for the PowerShell step. For more information, see [Test a credential for the PowerShell step](../../integrate-applications/integration-hub/test-credential-powershell.md).
