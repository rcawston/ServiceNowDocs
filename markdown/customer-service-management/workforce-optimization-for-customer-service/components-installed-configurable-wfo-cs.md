...
</table>**Note:** Channel management properties are not visible by default in the \[sys\_properties\] table. To use any of the channel management properties, you must add the required property to the System Property \[sys\_properties\] table. For more information, refer to [Add a system property](../../platform-administration/r_AvailableSystemProperties.md).
