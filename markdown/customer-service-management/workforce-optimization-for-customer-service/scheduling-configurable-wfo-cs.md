...
-   **[Create a shift plan](create-shift-plan-configurable-wfo-cs.md)**  
...
-   **[Create a schedule plan](create-schedule-plan-configurable-wfo-cs.md)**  
...
-   **[Track and manage your team schedule](track-manage-teams-schedule-configurable-wfo.md)**  
...
-   **[Create recurring meetings](create-recurring-meeting-wfo.md)**  
...
-   **[Add events to the team calendar](adding-event-calendar-configurable-wfo-cs.md)**  
Create a meeting, training, time-off request, or an ad hoc work event from the team calendar.
-   **[Swap agent shifts in Workforce Optimization for Customer Service](swap-agent-shifts-configurable-wfo-cs.md)**  
Swap an agent's shift in an assignment group with another agent who can work on that shift and skip the approval process.
-   **[Enable your teams to sign up for work shifts](agent-shift-signup-wfo-csm.md)**  
Empower your teams to sign up for work shifts based on their availability and preference.
-   **[Sign up for your preferred shifts](sign-up-preferred-shifts-wfo-csm.md)**  
