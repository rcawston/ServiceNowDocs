...
From the Customer and Consumer Portals, end users can select available services from the [Services portal widget](csm-service-definitions.md#services-portal-widget). Selecting a service displays the record producer associated with the service definition. Submitting the record producer creates a case of the correct case type.
...
[Service Catalog items](../servicenow-platform/service-catalog/c_IntroductionToCatalogItems.md)

[Create or edit a catalog item](../servicenow-platform/service-catalog/t_DefineACatalogItem.md)
