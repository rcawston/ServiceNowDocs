...
-   **Schedule**: create or modify schedules. For more information, see [Schedules](../platform-administration/time-configuration/c_UseSchedules.md).
...
[Creating and using schedules](../platform-administration/time-configuration/c_UseSchedules.md)
