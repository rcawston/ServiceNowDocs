...
You cannot renew an entitlement when it is in Canceled state or it does not have an end date. For more info, see [Order fulfillment](../order-management/reviewing-orchestration-plans-order-fulfillment.md).
