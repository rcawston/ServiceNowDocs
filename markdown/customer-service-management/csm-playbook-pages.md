...
Pages provide the base structure for how the system displays record information in CSM Configurable Workspace. You can create and customize pages with [UI Builder](../application-development/ui-builder/ui-builder-overview.md), a web user interface builder.
...
[Configure an email template](../platform-user-interface/configure-email-templates.md)
...
[Add an activity to a playbook](../build-workflows/workflow-studio/playbook-add-optional-activity.md)
