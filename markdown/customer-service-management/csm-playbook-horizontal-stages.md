...
The audience determines who can see the page variant. The Case playbook: horizontal stages page variant does not have an audience. This means everyone with access to the experience can see this page variant.For more information, see [Learn about audiences](../application-development/ui-builder/add-audiences.md).
