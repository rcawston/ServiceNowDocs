...
The audience determines who can see a record page. The Order case record page does not have a specified audience.For more information, see [Learn about audiences](../application-development/ui-builder/add-audiences.md).
