...
To learn more about the configuration of the pre-chat surveys, see [Define pre-chat survey configurations](../conversational-interfaces/ac-configure-pre-chat-surveys.md).
