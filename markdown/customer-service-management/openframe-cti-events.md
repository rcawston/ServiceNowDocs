...
As a CTI developer, ensure that you subscribe to the following events by using the subscribe method of the openFrameAPI.​ For more information, see [openFrameAPI - Client](../api-reference/c_openFrameAPI.md).
