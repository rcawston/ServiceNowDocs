...
4.  Manage your customer service cases based on your role.
    ...
    For more information about the agent and manager tasks, see [Use mobile application to perform agent and manager tasks](csm-mobile-agent-mgr-task.md).


-   **[Use mobile application to perform agent and manager tasks](csm-mobile-agent-mgr-task.md)**  
