...
Records appear in the Related Records tab in a card format. This format is created with [Entity View Action Mapper](../servicenow-platform/entity-view-action-mapper-evam/entity-view-action-mapper.md) \(EVAM\), a ServiceNow AI Platform application that standardizes how different data sources display in cards and lists.
...
-   [Define an EVAM view configuration](../servicenow-platform/entity-view-action-mapper-evam/configuring-entity-view-action-mapper.md)
-   [Define an EVAM view template](../servicenow-platform/entity-view-action-mapper-evam/define-evam-template.md)
