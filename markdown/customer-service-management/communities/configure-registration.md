...
-   [Configure the required strength for passwords](../../servicenow-platform/password-reset/config-pwd-strength-rqmts.md).
-   [Create an email template](../../platform-administration/t_CreateAnEmailTemplate.md) and content. The email template that you can change is **communities.ext.regn.confirm**.
