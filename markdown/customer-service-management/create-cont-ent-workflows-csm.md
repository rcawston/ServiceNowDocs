...
-   Sales Cycle Type: In the Code field, enter **RENEW** and set the Active option to **True**. For more info, see [Create a sales cycle for an opportunity](../order-management/opportunity-management-sales-cycle-types.md).
-   Opportunity Stage: In the Name field, enter **Develop** and set the Active option to **True**. For more info, see [Create opportunity stages](../order-management/opportunity-management-opportunity-stages.md).
