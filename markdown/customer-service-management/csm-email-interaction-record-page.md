...
The audience determines who can see the page variant. The Email Interaction record page does not have a defined audience.For more information, see [Learn about audiences](../application-development/ui-builder/add-audiences.md).
