...
The Hardware Asset Management fulfills the service request and executes the workflow to procure the assets in the Hardware Asset Management Workspace. To learn more about the Hardware Asset Management workflow, see [Procurement](../../it-asset-management/procurement/c_Procurement.md).
