...
Time interval to use for running the scheduled job. To learn more, see [Automatically generate something from a template](../../platform-administration/time-configuration/t_ScheduleTheGenerationOfAnEntity.md).
