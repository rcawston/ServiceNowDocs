...
You can also add a new model state to the Change model based on the requirements of your Design and Assign function. To learn more, see [add multi-layer model states](../../it-service-management/change-management/t_AddANewState.md).
...
[Create a Change model](../../it-service-management/change-management/create-a-change-model.md)

[Legacy: State model and transitions](../../it-service-management/change-management/c_ChangeStateModel.md)
