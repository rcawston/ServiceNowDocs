...
For more information about Trust configuration and Trust configuration management, see [Cross-instance application trust configuration](../../platform-administration/grant-access-v2.md)
