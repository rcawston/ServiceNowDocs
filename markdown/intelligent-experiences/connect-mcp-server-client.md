...
6.  On the form, fill in the required fields.
    ...
    For more information about this form, see [Configure an OAuth authorization code grant](../platform-security/authentication/configure-an-oauth-authorization-code-grant.md).
