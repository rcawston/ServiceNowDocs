...
-   NLQ Cmdb Implicit Relationships. For more information see [Intelligent Search for CMDB](../../servicenow-platform/configuration-management-database-cmdb/intelligent-search-cmdb.md).
