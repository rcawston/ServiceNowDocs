...
3.  Set the channel identity.
    ...
    2.  Select the **AI Voice Agent Provider Application** record to open it.
        ...
        If you want to use an existing application or create a new provider application, be sure to update the existing configuration according to the values mentioned in [Configuration for custom AI voice agent provider](voice-agent-reference.md#configuration-for-custom-ai-voice-agent-provider) before proceeding further.
