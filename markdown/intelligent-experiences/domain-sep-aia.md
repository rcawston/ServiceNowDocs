...
-   The Domain Separation plugin is installed on your instance and active. For more information, refer to [Domain separation plugin](../platform-security/domain-sep-plugin.md).
