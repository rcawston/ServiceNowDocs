...
-   Now Assist Panel: Now Assist Panel operates as a unified assistant across multiple workspaces, hence it is essential to tag tables as follows:
    ...
    -   For more information on adding workspace tags in Now Assist Panel, see [Add a Knowledge Graph schema to a chat assistant](../../conversational-interfaces/now-assist-in-virtual-agent/add-kg-schema-assistant.md).
