...
The Rally Integration Hub spoke must be active. For more information, see [Rally spoke](../../integrate-applications/integration-hub/rally-spoke.md).
...
**Important:** You must select the **Rally Spoke** check box for this integration while installing optional features on the [Application Manager](../../platform-administration/application-manager/application-manager.md) page. For more information about choosing the required SaaS applications, see [Request SaaS License Management](request-saas-license-management.md).
