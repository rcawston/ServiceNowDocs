...
4.  Select **Add** to open the Add asset dialog box.
    ...
    For details on the type of assets that appear, see the section titled [Considerations for adding assets to asset groups](asset-groups-eam.md#considerations-for-adding-assets-to-asset-groups).
