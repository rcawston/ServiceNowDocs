...
-   **[Create a task rate card in Hardware Asset Workspace](create-ham-task-rate-card.md)**  
Create a task rate card to define the type of task and the method of calculating the associated costs.
-   **[Create a labor rate card in Hardware Asset Workspace](create-ham-labor-task.md)**  
Create a labor rate card to record the time worked on a task and associate a rate to the task.
-   **[Create a TCO report in Hardware Asset Workspace](create-ham-tco-report.md)**  
