...
For more information on Microsoft SQL Server component edition discovery, see [MSSQL server discovery](../../it-operations-management/itom-visibility/mssql-data-collected-pattern.md).
