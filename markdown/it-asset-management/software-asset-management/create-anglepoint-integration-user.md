...
Option to designate the user as an internal integration user. See [Mark service accounts as internal integration users](../../api-reference/web-services/t_MarkSvcAcctsAsInternalIntegUsers.md) for more information on internal integration users.
