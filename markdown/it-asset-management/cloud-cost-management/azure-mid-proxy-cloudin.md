...
See [Proxy server configuration for MID Servers used for Cloud Discovery and Cloud Provisioning and Governance](../../it-operations-management/mid-server-proxy.md).
