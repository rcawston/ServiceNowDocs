...
Models published to the product catalog are automatically published to the [Service Catalog](../../servicenow-platform/service-catalog/service-catalog.md). The service catalog includes information about goods \(models\) and services. If the model is available from multiple vendors, a model can be listed more than once. Models are included with the Asset Management application.
...
[Asset and CI management](../hardware-asset-management/c_ManagingAssets.md)
