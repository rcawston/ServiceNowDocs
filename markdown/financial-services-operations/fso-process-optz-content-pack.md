...
For information about enabling the FSO Process Mining Content Pack, see [Content pack for Financial Services Operations](../now-intelligence/process-mining/integration-fso-process-opt.md).
...
You can also configure a new process project that is based on a pre-built project. For more information, see [Create a project or template using Project Builder](../now-intelligence/process-mining/define-workflow-model.md).
