...
|CSM Contributor User|Enables middle office teams to create cases for customer requests. For more information, see [CSM Contributor User](../../customer-service-management/config-contributor-user.md).|
