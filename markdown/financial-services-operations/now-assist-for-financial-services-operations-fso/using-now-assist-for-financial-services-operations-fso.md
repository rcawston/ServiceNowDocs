...
-   **Disputes intake via Virtual Agent**
    ...
    **Note:** Certain questions will not infer answers from Now LLM to ensure that the correct dispute category and reason code are determined from the conversation. See [Bypassed questions from LLM processing](learn-about-the-form-data-collector.md#id_fy4_shj_xgc) for more information.
