...
The table that is accessed in this scenario is the [Consumer](fso-int_guide-table_defs.md#consumer-csm-consumer-table) \[csm\_consumer\] table which contains the business-to-customer records.
