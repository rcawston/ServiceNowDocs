...
Ensure that the scope is selected for the application for which you are configuring a flow. For more information, see [Application picker](../application-development/c_ApplicationPicker.md).
...
The flows are built using ServiceNow Workflow Studio, so make sure you’re familiar with [Flow Designer](../application-development/flow-designer.md) basics.
