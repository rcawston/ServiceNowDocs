...
3.  On the form, fill in the fields.
    ...
    For information about the fields, refer to [Assignment Configuration New Record](../governance-risk-compliance/grc-common-functions/assignment-configuration-new-record.md).
