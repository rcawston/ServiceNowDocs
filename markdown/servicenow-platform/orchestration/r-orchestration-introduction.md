...
-   **[Configuring Password Reset](../password-reset/password-reset-admin-guide.md)**
...
-   Any system exposing web services \([SOAP,](t_CreateASOAPWebServiceActivity.md) [REST](t_CreateARESTWebServiceActivity.md#)\)
...
-   Numerous proprietary services: Windows [Active Directory](c_OrchActiveDirectoryActivities.md), Microsoft [Exchange](c_OrchestrationExchangeActivities.md) mail servers, [InfoBlox](c_InfobloxDDIActivityPack.md), and [F5 Networks](c_OrchF5LoadBalancerActivities.md).
