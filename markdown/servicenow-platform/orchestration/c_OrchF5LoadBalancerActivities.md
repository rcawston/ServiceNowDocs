...
All F5 custom activities are in the F5 Network Management Application [Application scope](../../application-development/c_ApplicationScope.md) and are activated by the Orchestration - F5 network management plugin, which must be [activated by request](t_ActivateAnActivityPack.md).
