...
This module file stores the functions used by the PowerShell scripts shipped with the [Active Directory](c_OrchActiveDirectoryActivities.md) activity pack.
