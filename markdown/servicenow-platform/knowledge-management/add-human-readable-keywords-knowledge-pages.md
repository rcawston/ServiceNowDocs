...
4.  On the Knowledge Article View form, in the **Human readable url structure** field enter the `%short_descr` variable.
    ...
    **Note:** You can also create a variable to add information from various data sources. For more information, see [Add human readable keywords to page URLs](../../platform-user-interface/service-portal/add-human-readable-keywords-page-urls.md).
