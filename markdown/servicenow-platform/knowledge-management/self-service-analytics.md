...
Display the effectiveness of self-service channels by using reports and dashboards based on the data generated by the Self-Service Analytics framework. This Self-Service Analytics data is used by the Self-Service Analytics dashboard for customer service. You can also use the Self-Service Analytics framework in dashboards of other applications that use the Subscriptions and Activity Feed Framework. For more information, see [Self-Service Analytics dashboard for customer service](../../customer-service-management/analytics-and-reporting-solutions-for-customer-service/ssa-cs-dashboard.md).
...
[Platform Analytics Solutions for Self-Service Analytics for Customer Service](../../customer-service-management/analytics-and-reporting-solutions-for-customer-service/ssa-cs-content-pack.md)
