...
-   I18N:Knowledge Management Internationalization Plugin v2 \(com.glideapp.knowledge.i18n2\) plugin. For more information, see [Activate a plugin](../../platform-administration/t_ActivateAPlugin.md).
-   Internationalization plugins for each appropriate language. For more information, see [Activate a language](../../platform-administration/system-localization/t_ActivateALanguage.md).
