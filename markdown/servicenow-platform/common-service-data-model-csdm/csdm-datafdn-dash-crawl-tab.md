...
For information on managing data collection for a metric that isn't needed or that affects performance of the dashboard, see [Manage performance](../configuration-management-database-cmdb/csdm-cmdb-foundations-dashboards.md#manage-performance).
