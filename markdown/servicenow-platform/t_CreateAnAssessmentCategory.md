...
2.  Open an assessment metric category to review it.
    ...
    |--------------------------|-----------|-----------|
    |**Size**|**T-Shirt size** field on the [Demand](../it-business-management/demand-management/t_CreatingDemands.md) form.|Assesses demand size relative to the size of other demands.|
