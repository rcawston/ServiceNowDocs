...
The Catalog item translation coverage graph is displayed only if you have enabled the Localization framework. For more information, see [Localization Framework](../../platform-administration/localization-framework/localization-framework-landing.md).
