...
-   Test user criteria on a development or test instance, and then transfer the records from the user criteria tables and catalog records to your production instance using [update sets](../../application-development/system-update-sets/system-update-sets.md).
