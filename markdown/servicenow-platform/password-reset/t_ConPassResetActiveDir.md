...
4.  Click **New**, complete the form with the following values for the AD credential, and then click **Submit**.
    ...
    **Note:** If you are using Integration Hub, from the Microsoft AD Credential store, click **Microsoft AD Connection Alias** to create a new connection. To learn more, see [Set up the Microsoft AD v2 spoke](../../integrate-applications/integration-hub/setup-ms-ad-v2.md).
