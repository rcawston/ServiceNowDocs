...
To create custom prompts for OOB and custom knowledge article templates, clone the existing KB generation skill, from the Now Assist skill Kit \(NASK\). For more information, see [Now Assist Skill Kit](../../intelligent-experiences/now-assist-skill-kit/now-assist-skill-kit-landing.md) Configuration of the skill happens in three steps:
...
11. Evaluate the prompt.
    ...
    For more, see [Evaluate a prompt](../../intelligent-experiences/now-assist-skill-kit/evaluate-prompt.md)
