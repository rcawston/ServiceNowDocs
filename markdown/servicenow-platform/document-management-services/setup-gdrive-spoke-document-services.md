...
1.  Set up and connect Google Drive Spoke.
    ...
    For more information, see [Set up Google Drive spoke](../../integrate-applications/integration-hub/setup-gdrive.md).

2.  Set up and connect Google Directory Spoke.

    For more information, see [Google Directory Spoke](../../integrate-applications/integration-hub/gdirectory-spoke.md).

3.  Set up and connect Google Doc Spoke.

    For more information, see [Google Docs Spoke](../../integrate-applications/integration-hub/gdocs-spoke.md).
