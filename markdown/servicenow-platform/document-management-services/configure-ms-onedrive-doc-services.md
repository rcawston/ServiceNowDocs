...
-   Set up and connect Microsoft Entra ID Spoke, see [Set up Microsoft Entra ID spoke](../../integrate-applications/integration-hub/set-up-azure.md) and [Microsoft OneDrive Spoke](../../integrate-applications/integration-hub/onedrive-spoke.md).
...
5.  Enable the permissions you want the application to support.
    ...
    3.  Select the delegated or application permissions that the application supports.
        ...
        You must mention these API permissions in the **OAuth Entity scopes** tab while configuring the [application registry](../../integrate-applications/integration-hub/setup-msonedrive.md).
