...
Create a CMDB 360 report to integrate CMDB 360 query results with platform [Reporting capabilities](../../now-intelligence/reporting/reporting-landing-page.md). Each run of the query automatically updates the generated report.
