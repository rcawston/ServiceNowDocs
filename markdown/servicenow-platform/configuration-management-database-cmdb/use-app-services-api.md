...
Use the [getContent - GET](../../api-reference/rest-apis/application-service-api.md) REST API to retrieve a list of CIs and the relationships between them, for an application service that was created manually.

## Additional APIs

The following JavaScript APIs are also available:

-   [addCI\(\)](../../api-reference/server-api-reference/BusinessServiceManagerAPI.md): Add a CI to a manually created an service instance.
...
-   [addManualConnection\(\)](../../api-reference/server-api-reference/BusinessServiceManagerAPI.md): Add a manually created connection to an application service.

-   [migrateManualToApplicationService\(\)](../../api-reference/server-api-reference/BusinessServiceManagerAPI.md): Convert a manual service to an application service.

-   [populateApplicationService\(\)](../../api-reference/server-api-reference/BusinessServiceManagerAPI.md): Populate an application service with CIs and relationships from the designated entry point.

-   [removeCI\(\)](../../api-reference/server-api-reference/BusinessServiceManagerAPI.md): Remove a manually created CI from an application service.

-   [removeManualConnection\(\)](../../api-reference/server-api-reference/BusinessServiceManagerAPI.md): Remove a manually created connection and the connected CI from an application service.


**Related topics**  


[Application Service API](../../api-reference/rest-apis/application-service-api.md)
