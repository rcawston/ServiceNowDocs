...
9.  On the **Determine Duplicate CI Actions** tab, choose one of the following actions to perform after completing the reconciliation. Then select **Next**.
    ...
    -   **Delete**: Delete all duplicate CIs \(only the main CI remains\).
        ...
        **Note:** Review [Roll back and delete recovery](../../platform-administration/table-administration-and-data-management/rollback-delete-recovery.md) for information about reverting the deletion of CIs and related records.
