...
To avoid timing out for very large surveys, you can disable the transaction quota. See [Transaction quotas](../platform-administration/platform-performance/c_TransactionQuotas.md).
