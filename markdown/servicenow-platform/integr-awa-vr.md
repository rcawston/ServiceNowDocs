...
5.  To enable Advanced Work Assignment \(AWA\) Voice routing, check the checkbox under the **AWA Voice Routing** heading.
    ...
    1.  Complete [AWS Lambda](../integrate-applications/integration-hub/aws-lambda-spoke.md) and OAuth credential setup.
...
6.  Set up AWA queue to route Amazon Connect phone calls.
    ...
    To setup AWA, see [Get started with Advanced Work Assignment](../conversational-interfaces/advanced-work-assignment/implement-awa.md)
