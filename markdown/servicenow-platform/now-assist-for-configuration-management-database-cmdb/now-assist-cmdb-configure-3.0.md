...
5.  Install the Now Assist for CMDB plugin.
    ...
    For instructions on the installation process, see [Install Now Assist plugins](../../intelligent-experiences/install-now-assist-feature-plugins.md).
