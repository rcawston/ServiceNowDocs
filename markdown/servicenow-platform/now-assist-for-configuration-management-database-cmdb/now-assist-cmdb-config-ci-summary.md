...
Event Management must be activated for the CI summarization skill. For more information, see [Event Management](../../it-operations-management/event-management/c_EM.md).
...
Security Operations must be activated for the CI summarization skill. For more information, see [Security Operations](../../security-management/security-operations-landing-page.md).
