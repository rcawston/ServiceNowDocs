...
After you have followed the instructions provided to you to download and activate the Service Graph Connector for Rapid7 application, refer to [Download an application from the ServiceNow Store for the first time](../../security-management/download-app-first-time.md) and [Install a Security Operations integration](../../security-management/install-non-core-apps.md). There are a few steps you need to complete before you configure this integration.
