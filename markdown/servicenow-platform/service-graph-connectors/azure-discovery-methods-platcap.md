...
-   You must provide ITOM Visibility with access permissions. For more information, see [Set up Azure service accounts](../../it-operations-management/setup-azure-service-accounts.md)
