...
Use the [condition builder](../platform-user-interface/c_ConditionBuilder.md) to define the criteria for the workflow trigger. If you selected the **Use filter group** check box and selected a filter group, the **Condtion** fields are not displayed.
