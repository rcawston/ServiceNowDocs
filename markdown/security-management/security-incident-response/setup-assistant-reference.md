...
3.  Select **OK** in the Warning confirmation box.
    ...
    For more information, see [Repair SLAs](../../it-service-management/service-level-management/c_RepairSLAs.md).
...
6.  To [edit the details of the knowledge article](../../servicenow-platform/knowledge-management/create-knowledge-article.md), click **Edit Article**.
...
3.  Fill in the fields, as needed.
    ...
    |Conditions|Use the [condition builder](../../platform-user-interface/c_ConditionBuilder.md) to validate whether an email sent to your company phishing email address is a phishing attack. See the following example.|
