...
Set up
 ...
 [Get started with the Microsoft Exchange On-Premises integration](activate-configure-ms-exch-on-prem-integ.md)

</td></tr><tr><td>

Use

 [Search for and delete phishing emails](search-delete-exchange-emails.md)
