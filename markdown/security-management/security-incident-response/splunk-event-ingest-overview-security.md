...
This integration requires an installed and configured MID Server in your ServiceNow AI Platform® instance to connect to the Splunk service when the Splunk server is deployed within your corporate network. If you are using the Splunk Cloud service, a MID Server is not required. See [MID Server](../../servicenow-platform/mid-server/mid-server-landing.md) for more information about MID Servers.
