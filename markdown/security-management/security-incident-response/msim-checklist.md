...
Microsoft SharePoint manages sites, folders, files, groups, and users in Microsoft SharePoint.
 ...
 For information, see [Microsoft SharePoint spoke v1.1.2](../../integrate-applications/integration-hub/sharepoint-online-spoke.md) documentation on how to setup REST and Graph connections Configuration.
