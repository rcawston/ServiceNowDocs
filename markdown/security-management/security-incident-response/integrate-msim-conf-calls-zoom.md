...
To configure the MSIM Conference Call Zoom integration using the Notify communication channel, see [Configure Notify Zoom connector in Notify](../../servicenow-platform/notify/configure-notify-zoom-connector.md).

-   **[Use the MSIM Conference Call Zoom integration](using-conf-call-zoom-integration.md)**  
