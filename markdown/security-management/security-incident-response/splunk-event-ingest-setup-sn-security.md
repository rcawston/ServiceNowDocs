...
1.  Verify that you have assigned the required ServiceNow AI Platform® and Security Incident Response \(SIR\) roles.
    ...
    For more information, see [Managing roles](../../platform-administration/user-administration/ua-creating-roles.md).
...
4.  Verify that you have installed and configured a MID Server.
    ...
    A MID Server in your ServiceNow AI Platform® instance is required to connect to the Splunk service if the Splunk server is deployed within your corporate network. For information, see [MID Server](../../servicenow-platform/mid-server/mid-server-landing.md).
