...
Explore
 ...
 -   [CrowdStrike Falcon Intelligence integration overview](crowdstrike-intell-integration.md#)
-   [Security Incident Response integrations](security-incident-response/sir_integrations.md)

</td><td>

Set up

 [Activate and configure the CrowdStrike Falcon Intelligence integration](crowdstrike-intell-integration.md#)
...
-   [Threat Lookup - CrowdStrike Falcon Intelligence flows](crowdstrike-intell-integration.md#)
