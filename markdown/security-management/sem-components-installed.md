...
To view the full list of installed components, use the Application Files table. For instructions, see [Find components installed with an application](../platform-administration/find-components.md).
