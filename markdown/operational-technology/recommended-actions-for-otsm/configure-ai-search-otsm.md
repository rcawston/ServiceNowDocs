...
For Operational Technology Service Management users, you must define the OT incident \[sn\_ot\_incident\] table as an indexed source in order to use AI Search for OT incident records. For more information about indexing, see [Indexed sources in AI Search](../../platform-administration/ai-search/indexed-sources-ais.md).
...
To define indexed sources, you can use the Guided Setup for AI Search. The following procedure describes how to access the **Define indexed sources** task. For more information about the Guided Setup for AI Search, see [Configuring AI Search](../../platform-administration/ai-search/configuring-ais.md).
