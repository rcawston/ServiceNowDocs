...
1.  To access the Industrial services page, assign the **cmdb\_ot\_viewer** role.
    ...
    For more information about how to assign roles, see [Assign a role to a user](../platform-administration/user-administration/t_AssignARoleToAUser.md).
...
3.  Add more connected content to the Employee Center for OT.
    ...
    You can optionally add content to the Industrial services topic page as needed for your organization. For more information about how to add content in the Employee Center, see [Add menu items to primary navigation](../employee-service-management/employee-experience-foundation/add-menu-items.md).
