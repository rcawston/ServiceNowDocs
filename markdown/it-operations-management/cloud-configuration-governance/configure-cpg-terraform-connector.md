...
3.  To use Terraform Open Source as a config provider for Cloud Provisioning and Governance, do the following:
    1.  Assign Terraform capability to the MID Server. For more information, see [Configure MID Server capabilities](../../servicenow-platform/mid-server/t_ConfigureCapabilities.md).
...
4.  To use Terraform Enterprise or Terraform Cloud as a config provider for Cloud Provisioning and Governance, do the following:
    1.  Assign Terraform Enterprise and REST capabilities to the MID Server. For more information, see [Configure MID Server capabilities](../../servicenow-platform/mid-server/t_ConfigureCapabilities.md).
