...
1.  Retrieve the value in the **mid.aws.sts.assume\_role.credential\_ttl\_minutes** [MID Server property](../../servicenow-platform/mid-server/r_MIDServerProperties.md).
