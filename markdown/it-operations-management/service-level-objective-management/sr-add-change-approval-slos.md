...
Review change approval policies and their terminology, including policy inputs, decisions, and approval definitions. For more information, see [Change approval policies](../../it-service-management/change-management/change-approval-policy.md).
