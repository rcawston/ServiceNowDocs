...
-   Verify that the Log Export Service \(LES\) is installed on your ServiceNow instance. LES is a ServiceNow Platform tool under a different license than Health Log Analytics that enables you to export your system logs seamlessly into HLA. For more information, see [Log Export Service \(LES\)](../../platform-security/les-intro.md).
