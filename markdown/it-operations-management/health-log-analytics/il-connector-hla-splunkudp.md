...
6.  On the **Provide details** form, fill in the fields.
    ...
    For a description of the fields, see **Provide details** table in [Splunk UDP integration configuration fields](il-connector-hla-splunkudp-fields.md).

7.  Select **Advanced settings** and fill in the advanced configuration fields.

    For a description of the fields, see the **Advanced settings** table in [Splunk UDP integration configuration fields](il-connector-hla-splunkudp-fields.md).
