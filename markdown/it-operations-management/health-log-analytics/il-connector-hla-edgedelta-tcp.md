...
6.  On the **Provide details** form, fill in the fields.
    ...
    For a description of the fields, see the **Provide details** table in [Edge Delta TCP integration configuration fields](il-connector-hla-edgedelta-tcp-fields.md).

7.  Select **Advanced settings** and fill in the advanced configuration fields.

    For a description of the fields, see the **Advanced settings** table in [Edge Delta TCP integration configuration fields](il-connector-hla-edgedelta-tcp-fields.md).
