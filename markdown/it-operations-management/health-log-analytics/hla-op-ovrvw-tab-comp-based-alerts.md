...
-   **Configuration Items**
    ...
    To view more detailed information on the CIs that are associated with the alert, select the **Configuration Items** tab or select **View more** in the Configuration Items section. See [Operator phase 1: Analyze and acknowledge an alert](../event-management/operator-phase-acknowledge-analyze.md).
