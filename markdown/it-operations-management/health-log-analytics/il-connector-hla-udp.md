...
6.  On the **Provide details** form, fill in the fields.
    ...
    For a description of the fields, see the **Provide details** table in [UDP integration configuration fields](il-connector-hla-udp-fields.md).

7.  Select **Advanced Settings** to set advanced configuration fields.

    For a description of the fields, see the **Advanced Settings** table in [UDP integration configuration fields](il-connector-hla-udp-fields.md).
