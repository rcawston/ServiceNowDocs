...
6.  On the **Provide details** form, fill in the fields.
    ...
    For a description of the fields, see the **Provide details** table in [Amazon S3 integration configuration fields](il-connector-hla-aws-s3-fields.md).
...
8.  On the **Set data retrieval method** form, fill in the fields.
    ...
    For a description of the fields, see the **Set data retrieval method** table in [Amazon S3 integration configuration fields](il-connector-hla-aws-s3-fields.md).

9.  Select **Advanced settings** and fill in the advanced configuration fields.

    For a description of the fields, see the **Advanced settings** table in [Amazon S3 integration configuration fields](il-connector-hla-aws-s3-fields.md).
