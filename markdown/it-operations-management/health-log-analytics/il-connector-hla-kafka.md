...
6.  On the **Provide details** form, fill in the fields.
    ...
    For a description of the fields, see the **Provide details** table in [Apache Kafka integration configuration fields](il-connector-hla-kafka-fields.md).

7.  Select **Next**.

8.  On the **Set data retrieval method** form, fill in the fields.

    For a description of the fields, see the **Set data retrieval method** table in [Apache Kafka integration configuration fields](il-connector-hla-kafka-fields.md).

9.  Select **Advanced settings** and fill in the advanced configuration fields.

    For a description of the fields, see the **Advanced settings** table in [Apache Kafka integration configuration fields](il-connector-hla-kafka-fields.md).
