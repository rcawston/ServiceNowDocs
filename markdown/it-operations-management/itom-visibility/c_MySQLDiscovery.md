...
-   [Applicative credentials](../../platform-security/connections-and-credentials/applicative-creds.md) \(When applications require credentials in addition to the credentials the that host machine requires.\)
