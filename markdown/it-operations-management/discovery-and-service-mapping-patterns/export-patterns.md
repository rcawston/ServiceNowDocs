...
3.  [Preview the imported update set](../../application-development/system-update-sets/t_PreviewARemoteUpdateSet.md).

    The system scans and validates the update set and displays its contents on the **Customer Updates** tab.

4.  [Commit the update set](../../application-development/system-update-sets/t_CommitAnUpdateSet.md).
