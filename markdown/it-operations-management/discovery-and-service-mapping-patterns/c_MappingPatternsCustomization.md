...
[Class diagrams and class attributes for key CMDB classes](../../servicenow-platform/configuration-management-database-cmdb/c_ConfigurationManagementDatabase.md)

[Description of key CMDB tables in the base system](../../servicenow-platform/configuration-management-database-cmdb/cmdb-tables-details.md)

[CMDB CI Class Models: ServiceNow Store app that adds class models that extend the base CMDB class hierarchy](../../servicenow-platform/cmdb-ci-class-models/cmdb-ci-class-models.md)

[Information about the various options for populating the CMDB](../../servicenow-platform/configuration-management-database-cmdb/c_OptionsToPopulateCMDB.md)

[ServiceNow Store apps that provide pre-defined Service Graph connectors for importing and integrating common third-party data into CMDB classes](../../servicenow-platform/configuration-management-database-cmdb/cmdb-third-party-integrations.md)
