...
-   Capability — defines the network capability. For Service Mapping, set this parameter to ALL or any combination of SSH, WMI, SNMP, and Cloud Provisioning and Governance . See [Configure MID Server capabilities](../../servicenow-platform/mid-server/t_ConfigureCapabilities.md).

-   IP range — limits operation of this MID Server to this IP range. Service Mapping does not choose this MID Server for a discovery request whose endpoint is outside this IP range. See [Configure an IP address range for the MID Server](../../servicenow-platform/mid-server/t_ConfigureMIDIPRange.md).
...
[MID Server connection prerequisites](../../servicenow-platform/mid-server/c_MIDServerConnectionPrerequisites.md)
...
[Multiple MID Server deployments](../../servicenow-platform/mid-server/t_InstallMultplMIDSvrOnASingleSys.md)

[MID Server installation](../../servicenow-platform/mid-server/mid-server-installation.md)
