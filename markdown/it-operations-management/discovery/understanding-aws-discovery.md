...
6.  Collecting data with Service Graph Connectors: Imports and integrates AWS data into CMDB and non-CMDB tables. Specializes in collecting the data for AWS Organizations. For more information, see [AWS discovery solutions comparison](aws-discovery-methods.md) and [Service Graph Connector for AWS](../../servicenow-platform/service-graph-connectors/cmdb-integration-aws-sg.md).
...
-   You must configure the discovery\_admin role for a user, to be able to run the discovery. For more information, see [Managing roles](../../platform-administration/user-administration/ua-creating-roles.md)
