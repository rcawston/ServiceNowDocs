...
Ensure you have [basic authentication credentials](../../platform-security/connections-and-credentials/r_BasicAuthCredentialsForm.md) for HTTP calls in the pattern.
