...
-   You have created a suitable OCI API credentials in the ServiceNow AI Platform to connect with the OCI user you want to use for discovery. For more information, see [Create Oracle API credentials](../create-oracle-api-credentials.md).
...
6.  Choose a MID Server.
    ...
    |Option|Description|
    |------|-----------|
    |**Use a cluster of MID servers**|Select an existing MID Server. Clusters provide failover protection and load balancing between MID Servers. See [Configure a MID Server cluster](../../servicenow-platform/mid-server/t_ConfigureAMIDServerCluster.md) for more information.|
