...
[Service Graph Connector for GCP](../../servicenow-platform/service-graph-connectors/sgc-cmdb-integration-gcp.md)

</td><td>

[Configure Service Graph Connector for GCP using the guided setup](../../servicenow-platform/service-graph-connectors/sgc-config-gcp-integration.md)
