...
Ensure that the Predictive Intelligence plugin is activated. To activate this plugin, see [Activate a plugin](../../platform-administration/t_ActivateAPlugin.md).
