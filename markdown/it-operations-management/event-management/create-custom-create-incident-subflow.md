...
Copy an existing subflow, and then customize it. Publish the custom subflow so that it is available to be used to resolve any alert. For more information, see [Create a subflow](../../build-workflows/workflow-studio/create-subflow.md).
...
[Subflows](../../build-workflows/workflow-studio/subflows.md)
