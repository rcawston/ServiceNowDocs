...
|HTML|Text box for the HTML. Use the toolbar like most word processing tool bars. For more information on using the toolbar, see [Formatting icons for the HTML field editors](../../platform-administration/r_Formatting.md) .|
