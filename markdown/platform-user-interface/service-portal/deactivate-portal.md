...
If you don’t specify an alternate portal, users receive a message that the portal has been deactivated. You can customize these messages from the Message \[sys\_ui\_message\] table. For more information see, [Message table](../../platform-administration/system-localization/r_MessageTable.md).
