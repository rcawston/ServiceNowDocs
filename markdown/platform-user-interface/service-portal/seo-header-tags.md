...
For an example of inserting custom SEO tags into the knowledge article view page, see [Configure custom SEO tags for canonical URLs and localized knowledge articles](../../servicenow-platform/knowledge-management/configure-seo-knowledge.md).
