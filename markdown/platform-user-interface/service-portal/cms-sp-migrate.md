...
If you are considering transitioning from CMS to Service Portal, make sure that you understand the impact of moving to a mobile environment. Review the [Mobile client GlideForm \(g form\) scripting and migration](../../api-reference/scripts/r_MobilePlatformMigrationImpacts.md).
...
For additional information on GlideAjax, refer to [GlideAjax](../../api-reference/c_GlideAjaxAPI.md).

 To understand the impact of updating your CMS to work in a mobile environment, review [Mobile client GlideForm \(g form\) scripting and migration](../../api-reference/scripts/r_MobilePlatformMigrationImpacts.md).
