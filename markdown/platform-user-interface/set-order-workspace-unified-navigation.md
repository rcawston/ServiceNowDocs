...
To enable ordering of your workspaces, you must create a system property **glide.ui.next\_experience.workspace\_sorting** and set the value to **Order**. For more information, see [Add a system property](../platform-administration/r_AvailableSystemProperties.md).
