...
Creating custom Next Experience landing pages requires configuring page components in UI Builder. For a quick tutorial on using UI Builder, see [UI Builder quick start](../application-development/ui-builder/ui-builder-quick-start.md) in the UI Builder documentation.
...
5.  Create a variant of the default landing page by duplicating it.
    ...
    3.  Next to the **Audiences** field, select **Add** and then select an audience from the list.
        ...
        The audience defines who can see a page. By default, all users can see a page. For more information about audiences, see [Learn about audiences](../application-development/ui-builder/add-audiences.md) in the UI Builder documentation.
