...
1.  Create a UI interaction in UI Builder. For instructions, see [Create a UI interaction](../application-development/ui-builder/create-ui-interaction-show-alert.md).
...
For a detailed overview of UI interactions, see [UI interactions](../application-development/ui-builder/uib-ui-interactions.md).
