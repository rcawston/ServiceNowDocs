...
1.  AI Data Explorer skills.
    ...
    For information on how to activate AI Data Explorer skills, see [Activate AI Data Explorer skills](../now-intelligence/activate-now-ass-explorer.md).
...
2.  Activate Query Generation skills.
    ...
    For information on how to Activate Query Generation skills, see [Query Generation skills](../now-intelligence/enable-query-generation.md).
...
3.  Configure AI Search.
    ...
    For information on how to configure AI Search, see [Configuring AI Search](../platform-administration/ai-search/configuring-ais.md)
