...
**Note:** If you do not use CSDM 5.0 or later versions, see the Rome documentation for CSDM. For implementing CSDM framework, see [Implementing the CSDM framework in stages](../servicenow-platform/common-service-data-model-csdm/csdm-implementation-stages.md).
