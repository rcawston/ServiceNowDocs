...
To move your Core Business Suite configurations to a new instance using an update set, see [Manage update set for Now Assist for Setup](../platform-administration/ia-update-set.md).
