...
For information on using a centralized Admin Home dashboard to set up and manage applications, see [Now Assist for Setup](../platform-administration/ia-landing.md).
