...
5.  Select **Apply default configurations**.
    ...
    Applying default configurations sets the required default settings for the Legal. For information about default configurations, see [Legal default configurations](legal-default-configurations.md).
