...
11. Configure notifications sent through Email, Portal, and Workspace to users about submitted or assigned Source‑to‑Pay requests.
    ...
    -   To create Portal or Workspace notifications, see [Trigger conditions form](../employee-service-management/employee-experience-foundation/notif-trigger-form.md).
