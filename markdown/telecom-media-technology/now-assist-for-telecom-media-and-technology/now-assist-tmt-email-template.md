...
To enable the email sending, see [Outbound email configuration](../../platform-administration/r_OutboundMailConfiguration.md).

To enable the email receiving, see [Inbound email configuration](../../platform-administration/r_InboundMailConfiguration.md).
