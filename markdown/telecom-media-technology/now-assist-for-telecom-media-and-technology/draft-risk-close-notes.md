...
3.  Select the user role that can use this skill and select **Save** to activate the skill.
    ...
    For more details on creating the activity context group, see [Configure activity groups for the Customer History view](../../customer-service-management/configure-activity-groups-ca.md).
