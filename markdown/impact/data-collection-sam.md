...
1.  [Install the Data Collection Pack for SAM](dc-sam-install.md)
2.  [Configure Data Collection for SAM](dc-sam-config.md)
3.  [Activate Data Collection for SAM](dc-sam-activate.md)
4.  [Review SAM artifacts](dc-sam-install-artifacts.md)
