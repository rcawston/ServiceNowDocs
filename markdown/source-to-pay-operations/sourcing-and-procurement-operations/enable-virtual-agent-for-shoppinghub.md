...
The base system provides predefined Virtual Agent topics \(chatbot conversations\). To customize, duplicate, and edit a topic, see [Virtual Agent Designer](../../conversational-interfaces/virtual-agent/conversation-designer-virtual-agent.md)
