...
4.  Complete the initial configuration steps to set up CM Pro.
    ...
    For more information on setting up Contract Management Pro, see [Add and configure contract request functionality into your workspace](../../employee-service-management/contract-management-pro/cncore-uptake-steps.md).
