...
7.  Enter the email body, if necessary.
    ...
    By default, the email body contains the link to the finance case. You can also use the email templates. For more information on email templates, see [Email templates](../../platform-administration/c_EmailTemplates.md).
