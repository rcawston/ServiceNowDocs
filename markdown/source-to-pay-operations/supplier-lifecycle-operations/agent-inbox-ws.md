...
The agent inbox displays the queues that are assigned to you, the number of active chats in each queue, and the average wait time for chats in the queue. For more information, see [Inbox layout](../../conversational-interfaces/advanced-work-assignment/awa-inbox-layout.md).
