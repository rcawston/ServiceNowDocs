...
Training statistics data from the Class Confidence \[ml\_class\] table. For more information, see [Configuring target metrics](../../intelligent-experiences/predictive-intelligence/configuring-target-metrics-trained-classification-solution.md).Data type: Object
...
List of objects providing training statistics data. For more information, see [Configuring target metrics](../../intelligent-experiences/predictive-intelligence/configuring-target-metrics-trained-classification-solution.md).Data type: Array of Objects
