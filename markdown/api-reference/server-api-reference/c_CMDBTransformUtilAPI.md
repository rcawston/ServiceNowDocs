...
For additional information on Identification and Reconciliation and more detailed explanations of the data used by this method, see [Identification and Reconciliation \(IRE\)](../../servicenow-platform/configuration-management-database-cmdb/ire.md).
