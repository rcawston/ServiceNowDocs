...
Use these methods in server scripts to send a probe to the MID Server For more information, see [Create a JavaScript Probe activity](../../servicenow-platform/orchestration/t_CreateAJavaScriptProbeActivity.md).
