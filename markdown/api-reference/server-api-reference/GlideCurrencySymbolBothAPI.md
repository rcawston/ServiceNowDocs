...
This API allows you to work with currency symbols anywhere on the ServiceNow AI Platform, not just in [Currency](../../platform-administration/currency-administration/configure-and-use-default-currency-fields.md) and [FX Currency](../../platform-administration/currency-administration/fx-currency.md) fields.
