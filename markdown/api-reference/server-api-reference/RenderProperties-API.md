...
The following example is used in a condition for a UI action listed in the UI Actions \[sys\_ui\_action\] table. See also [Defining UI actions](../../platform-administration/c_UIActions.md).
