...
For more information on de-duplication of CIs, de-duplication tasks, and de-duplication templates, see [Duplicate CIs remediation](../../servicenow-platform/configuration-management-database-cmdb/de-duplication-tasks.md).
