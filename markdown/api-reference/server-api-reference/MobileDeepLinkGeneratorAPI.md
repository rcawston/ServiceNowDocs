...
For an example of this API used in a push notification, see [Configure push notification message content](../../mobile/config-push-notification-message-content.md). For additional information on deep links, see [Deep linking for mobile](../../mobile/deep-link-mobile.md).
