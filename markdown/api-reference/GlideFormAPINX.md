...
[Annotations](../platform-administration/configure-form-layout.md) are visual separators between form elements, or blocks of colored text used to highlight form elements. Use [GlideForm \(Next Experience\) - getAnnotationByName\(String name\)](GlideFormAPINX.md#) to return a specific annotation by its name.
...
[Annotations](../platform-administration/configure-form-layout.md) are visual separators between form elements, or blocks of colored text used to highlight form elements. Use [GlideForm \(Next Experience\) - getAnnotations\(\)](GlideFormAPINX.md#) to return all annotations in a form.
