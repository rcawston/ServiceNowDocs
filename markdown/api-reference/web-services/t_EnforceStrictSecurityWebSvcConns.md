...
2.  Select **Yes** for **Enforce strict security on incoming SOAP requests**.
    ...
    **Note:** To learn more about this property, see [SOAP request strict security \(instance security hardening\)](../../platform-security/instance-security-hardening-settings/sc-soap-request-strict-security.md) in Instance Security Hardening Settings.
