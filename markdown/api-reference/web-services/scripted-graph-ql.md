...
To learn more about developing components, see [Developing components for Workspace](../../application-development/custom-components.md).
...
-   **Application namespace**
    ...
    The namespace for the custom application. To learn more about application namespaces, see [Application scope](../../application-development/c_ApplicationScope.md).
