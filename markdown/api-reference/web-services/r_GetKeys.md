...
A SOAP response element **sys\_id** that contains a comma delimited list of [Unique record identifier \(sys\_id\)](../../platform-administration/c_UniqueRecordIdentifier.md) values.
