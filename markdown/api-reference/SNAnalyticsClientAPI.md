...
For additional information, see [Usage Insights for Service Portal](../platform-user-interface/service-portal/sp-analytics.md).
...
This information appears in the user session timeline and on the analytics dashboard. Call this method within your custom widgets to track the pages visited by a user. You can also use this method to track user navigation within an individual page. For more information, see [Exploring Usage Insights](../now-intelligence/usage-insights/exploring-user-exp-analytics.md).
