...
This API can be used with the [m\_form - Client](m_formClientAPI.md#) API to auto-fill inputs on input form screens. For more information about input form screens, see [Input form screen](../../mobile/parameter-input-screen.md).
