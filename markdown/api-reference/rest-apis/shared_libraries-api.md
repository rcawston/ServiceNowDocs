...
For additional information on shared libraries and shared components, see [Sharing components among applications — Component libraries](../../it-service-management/devops-family/cdm-component-libraries.md).
...
Value of the publish option passed in the associated upload call. For additional information on publishing snapshots, see [Publish or unpublish a snapshot](../../it-service-management/devops-family/cdm-snapshot-publish.md).
