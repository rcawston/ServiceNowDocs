...
For additional information on policy mappings, see [Map policies to a deployable](../../it-service-management/devops-family/cdm-deployable-map-policy-to.md).
...
For additional information on policy mappings, see [Map policies to a deployable](../../it-service-management/devops-family/cdm-deployable-map-policy-to.md) and [Validating and correcting configuration data](../../it-service-management/devops-family/cdm-validating-cfg-data.md).
...
Details about the associated PaCE IO definition record.For additional information on PaCE, see [Policy as Code Engine \(PaCE\)](../../servicenow-platform/policy-as-code-engine-pace/pace-managing-policies.md).
...
Details about the PaCE policy-mapping record.For additional information on PaCE, see [Policy as Code Engine \(PaCE\)](../../servicenow-platform/policy-as-code-engine-pace/pace-managing-policies.md).
