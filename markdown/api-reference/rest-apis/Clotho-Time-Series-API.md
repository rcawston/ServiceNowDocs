...
List of metrics objects to use in the transform. For more information on metrics, see [Metrics](../../platform-administration/c_MetricDefinitionSupport.md).Data type: Array
