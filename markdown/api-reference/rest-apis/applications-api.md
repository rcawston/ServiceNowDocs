...
For additional information on Configuration Data Management and the DevOps Config Workspace UI, see [Uploading your config data](../../it-service-management/devops-family/cdm-upload-process.md).

For additional information on shared components and shared libraries, see [Sharing components among applications — Component libraries](../../it-service-management/devops-family/cdm-component-libraries.md).
...
Required. Name of the exporter to use to export the snapshot data. Exporters are custom to the implementer. For details on creating a custom exporter, see [Create a custom exporter](../../it-service-management/devops-family/cdm-exporter-create-custom.md).Data type: String
...
String that uniquely identifies the [changeset](../../it-service-management/devops-family/cdm-changesets-version-control.md) associated with the application, such as Chset-102. This changeset must be in the "Open" state.Data type: String
...
Only supported when the **dataFormat** parameter is set to `csv`. Attributes that define the CSV data format. For additional information, see [Parsing of CSV files in CDM](../../it-service-management/devops-family/cdm-parsing-csv-file.md).Data type: Object
