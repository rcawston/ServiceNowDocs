...
This API requires the Procurement Integration Framework \(com.glide.sn\_spend\_intg\) store application and is provided within the `sn_spend_intg` namespace. For information, see [Procurement File Transfer Framework](../../source-to-pay-operations/sourcing-and-procurement-operations/procurement-file-transfer-framework.md).
