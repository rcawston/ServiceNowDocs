...
To use this endpoint with additional CI types, [create metric definitions](../../servicenow-platform/metricbase/set-up-data-monitoring.md) and implement the scripted extension point TNIDCIMFeedParser.
