...
The Quote Management API requires the Quote Management \(com.sn\_quote\_mgmt\) plugin and the quote\_integrator role. This API belongs to the sn\_tmf\_api namespace. See [Quote Management](../../order-management/quote-management.md).
...
See [Create product characteristics and characteristic options](../../order-management/som-product-config-add-characteristics.md).
