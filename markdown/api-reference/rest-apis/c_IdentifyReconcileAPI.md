...
For more information on the IRE, see [Identification and Reconciliation engine \(IRE\)](../../servicenow-platform/configuration-management-database-cmdb/ire.md).
...
For more on Enhanced IRE options, see [Identification and Reconciliation engine \(IRE\)](../../servicenow-platform/configuration-management-database-cmdb/ire.md).
