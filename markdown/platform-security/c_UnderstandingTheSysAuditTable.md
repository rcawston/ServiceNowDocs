 ...
 **Note:** Some automated processes use the system or guest user to apply and track changes to records. For more information, see [System and guest users](../platform-administration/user-administration/user.md#system-guest-users).
