...
The Ask Now Assist context menu in ServiceNow Vault console lists common security tasks. Selecting a task opens a conversational interface that lets you accomplish the task through prompts. For more information about the Now Assist conversational interface, see [Now Assist panel](../intelligent-experiences/now-assist-panel-overview.md).
