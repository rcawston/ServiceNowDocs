...
-   Applies Access Control List rules \(ACLs\) to restricted scopes. To learn more about scoped ACLs, see [Access control list rules](../access-control/access-control-rules.md).
    ...
    **Note:** Some applications using scope administration and enforced security may require additional setup. To learn more, see [Manage HR roles](../../employee-service-management/hr-service-delivery/c_ManageRoles.md)
