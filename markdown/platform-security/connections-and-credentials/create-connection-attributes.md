...
Connection attributes are only used by integration steps, which require a subscription to Integration Hub. For more information about activating Integration Hub, see [Request an Integration Hub plugin](../../integrate-applications/integration-hub/request-integrationhub.md).
...
For more information about building custom Workflow Studio actions, see [Workflow Studio](../../build-workflows/workflow-studio/actions.md).
...
4.  Define the attribute label and field type.
    ...
    For a list of field types, see [field types](../../platform-administration/r_FieldTypes.md).

5.  Click the Advanced view related link to set advanced dictionary preferences for the attribute.

    For example, to create an attribute with a dynamically calculated value. See [Dictionary entry form](../../platform-administration/table-administration-and-data-management/r_DictionaryEntryForm.md).
