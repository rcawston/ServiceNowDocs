...
Users created for setting the password for their first login. For more information, see [Create a user](../../platform-administration/user-administration/t_CreateAUser.md).
