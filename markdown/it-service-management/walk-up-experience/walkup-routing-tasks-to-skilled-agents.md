...
Set up metadata in **All Skills**, **Group Skills**, and **User Skills**tables before configuring walk-up locations for skill-based routing. For more information, [Configuring Skills Management](../../servicenow-platform/skills-management/configuring-skills-management.md).
