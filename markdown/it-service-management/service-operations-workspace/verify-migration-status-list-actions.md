...
2.  If the migration fails, perform the following steps.
    ...
    4.  For each failed item, identify which step has failed and perform the steps mentioned in the [List actions migration from ITSM Agent Workspace to Service Operations Workspace for ITSM](list-actions-migration-itsm-aw-sow.md) section.
