...
For information about components installed with Service Operations Workspace for ITOM, see [Service Operations Workspace for ITOM reference](../../it-operations-management/service-operations-workspace-for-itom-apps/sow-reference-itom.md).
