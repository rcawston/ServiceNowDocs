...
</table>To configure catalog\_admin recipients for these notifications, refer to [Create a user group](../../platform-administration/user-administration/t_CreateAGroup.md).
