...
To use expense allocation rules, activate [Cost Management](../../it-business-management/cost-management/r_CostManagement.md).
...
[Condition builder](../../platform-user-interface/c_ConditionBuilder.md)
