...
1.  Install the Agent Client Collector Spoke plugin on the instance according to the [Agent Client Collector installation](../../it-operations-management/agent-client-collector/acc-installation.md) instructions.
...
5.  Duplicate and activate the Local Admin Access topic in the ITSM scope.
    ...
    To view, duplicate, preview, or publish IT Service Management topics in the Virtual Agent Designer, see [Getting started with Virtual Agent Designer](../../conversational-interfaces/virtual-agent/conversation-designer-virtual-agent.md).
