...
-   [Microsoft Exchange Server spoke](../../integrate-applications/integration-hub/msexchangeserver-spoke.md) \(sn\_exchange\_spoke\)
-   Email addresses for meeting attendees must be configured in the User \[sys\_user\] table to be added to meeting invites
-   Some topics can use the [Zoom spoke](../../integrate-applications/integration-hub/zoom-spoke.md) to add meeting links
