...
2.  Activate Workflow Studio flows for specific actionable notifications ITSM Virtual Agent conversations.
    ...
    These topics are inactive by default. For complete details about activating flows, refer to [Activate a flow](../../build-workflows/workflow-studio/flow-activate.md).
...
3.  [Enable notifications in Virtual Agent.](../../conversational-interfaces/virtual-agent/enable-va-notifications.md)
