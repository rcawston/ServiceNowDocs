...
-   **Report an Issue**
    ...
    Users can create incidents using a [Record Producer](../../servicenow-platform/service-catalog/c_RecordProducer.md).


**Parent Topic:**[Setting up ITSM Virtual Agent Lite](setup-itsm-virtual-agent-lite.md)
