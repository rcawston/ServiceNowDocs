...
For information on how to create a communication contact definition, refer to [Create communication contact definitions](../../servicenow-platform/task-communications-management/create-comm-contact-definition.md).
