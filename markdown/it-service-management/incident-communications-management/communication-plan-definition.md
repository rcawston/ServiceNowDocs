...
For information on how to create a communication plan definition, refer to [Create communication plan definition](../../servicenow-platform/task-communications-management/create-comm-plan-definition.md).

**Note:** If the UI16 module link redirection feature is enabled in Service Operations Workspace \(SOW\) and the UI16 module supports the redirect configuration, navigating through UI16 paths such as **My Communication Plans**, automatically redirects you to the equivalent list or record pages in SOW instead of displaying the UI16 forms or lists. For more information, see [Redirect UI16 module links to Service Operations Workspace](../service-operations-workspace/redirect-ui16-module-links-sow.md).
