...
4.  Fill in the fields on the form.
    ...
    For information on creating a new matching criteria, see [Create assignment workbench matching criteria](../../customer-service-management/create-assignment-wkbench-criteria.md).
