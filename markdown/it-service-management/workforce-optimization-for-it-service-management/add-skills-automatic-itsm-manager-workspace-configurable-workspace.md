...
**Note:** To add language detection skills, you must set dynamic translation APi. for more information, see [Dynamic Translation API](../../platform-administration/dynamic-translation/dyn-translation-apis.md).
...
2.  Add the desired rule for an incident or an interaction.
    ...
    For information, see [Create Skill Determination rules to assign skills to work items](../../servicenow-platform/skills-management/conf-simple-skill-determination-rule.md).
