...
Navigate to **All** &gt; **System Notifications** &gt; **Provider** &gt; **Notifications** to access the notifications below that are provided by default. For more information on adding notifications, see [Provider notification](../../platform-administration/notification-provider.md)
