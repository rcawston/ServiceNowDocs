...
1.  To create a service channel, do the following:
    ...
    2.  Click **New** and refer to the information in the [Create a service channel](../../conversational-interfaces/advanced-work-assignment/awa-create-service-channel.md) to create the service channel.
    3.  Click **Submit**.
...
2.  To create a queue, do the following:
    ...
    2.  Click **New** and refer to the information in [Create a work item queue](../../conversational-interfaces/advanced-work-assignment/awa-create-queue.md) to create the queue.
