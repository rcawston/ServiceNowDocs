...
2.  Resolve and close the problem.
    ...
    If the knowledge submission workflow is enabled, the problem **Work notes** become a knowledge submission instead of an article. For more information, see [Knowledge workflows](../../servicenow-platform/knowledge-management/r_KnowledgeWorkflows.md).
