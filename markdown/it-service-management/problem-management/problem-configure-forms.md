...
For additional form customization not described in this page, such as adding company-specific annotations or configuring related lists, see [Form administration](../../platform-administration/form-administration.md) and [Configuring the form layout](../../platform-administration/configure-form-layout.md).

By default, auditing is enabled for the problem table. The administrator can configure the form layout to add the Audit Records and Audit History related lists. For more information about options for auditing a table, see [Enable auditing for a table](../../platform-security/t_EnableAuditingForATable.md).
