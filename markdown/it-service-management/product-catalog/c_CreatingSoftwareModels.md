...
Software models are used in software counters. For more information about creating software model, see [Create software models](../../it-asset-management/software-asset-management/record-terms-software-licenses.md).
