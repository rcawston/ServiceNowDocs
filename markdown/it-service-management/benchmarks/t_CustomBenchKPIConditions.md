...
**Note:** Individual scores are shown by default but you must have [Performance Analytics](../../now-intelligence/performance-analytics/pa-overview.md) to use linking to show breakdowns.
...
3.  To link a Performance Analytics indicator to a Benchmarks indicator, follow the procedure in [Link an automated indicator to a benchmark](../../now-intelligence/performance-analytics/link-automated-indicator-benchmark.md).
