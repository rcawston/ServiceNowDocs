...
3.  Complete the form.
    ...
    For information about the fields in the **Financial** and **Contracts** sections of the form, see [Create assets](../../it-asset-management/asset-management/t_CreatingAssets.md).
