...
3.  On the form, modify information in the following form sections: **When to send**, **Who will receive**, **What it will contain**.
    ...
    For more information about email notifications and the fields in the form, see [Create an email notification](../../platform-administration/t_CreateANotification.md).
